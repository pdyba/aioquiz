...
from views.mentor.common import CommonMentorQuestionAutoGradeBase
...
class QuizMentorAutoGrade(CommonMentorQuestionAutoGradeBase):
    _cls = Quiz
    _urls = ['/api/mentor/autograde/quiz/<qid:int>']


class ExamMentorAutoGrade(CommonMentorQuestionAutoGradeBase):
    _cls = Exam
    _urls = ['/api/mentor/autograde/exam/<qid:int>']
