...
<script>
    import Tbl from '../../material_components/Table.vue';
    import TblHead from '../../material_components/TableHead.vue';
    import TblBody from '../../material_components/TableBody.vue';
            ...
            return {
                ...
                tab_2: [
                    ...
                    {'date': '2018.02.20', 'subject': 'BRAK ZAJĘĆ'},
                    {
                        ...
                        'author': ' Grzegorz Prokopczyk oraz Piotr Dyba'
                    }
                ],
                tab_3: [
                    {
