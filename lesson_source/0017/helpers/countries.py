...
#         print(count['name']['common'], count['capital'])
#
# for count in countries:
#     if len(count['currency']) > 1:
#         print(count['name']['common'], count['currency'])
...
max_name = ''
for count in countries:
    if len(count['borders']) > max_borders:
        max_name = count['name']['common']
        max_borders = len(count['borders'])
print(max_name, max_borders)
