...
$templateCache.put('partials/header.html','<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">\n    <div class="container">\n        <div class="navbar-header">\n            <button type="button" class="navbar-toggle" data-toggle="collapse"\n                    data-target=".navbar-ex1-collapse">\n                <span class="sr-only">Toggle navigation</span>\n                <span class="icon-bar"></span>\n                <span class="icon-bar"></span>\n                <span class="icon-bar"></span>\n            </button>\n            <a class="navbar-brand" href="#/">PyLadies.start()</a>\n        </div>\n        <div class="collapse navbar-collapse navbar-ex1-collapse">\n            <ul class="nav navbar-nav navbar-right">\n\n                <li ng-show="$parent.globals.currentUser">\n                    <a class="need-help"\n                       ng-click="help()"\n                       target="_self"\n                       ng-hide="$parent.globals.currentUser.seat.i_need_help"\n                       href=""\n                       style="background-position: 0 -1px;">HELP</a>\n                    <a class="need-help-clicked"\n                       target="_self"\n                       ng-show="$parent.globals.currentUser.seat.i_need_help"\n                       ng-click="help_stop()"\n                       href=""\n                       tyle="background-position: 0 -1px;">THX</a>\n                </li>\n                <li ng-show="$parent.globals.currentUser"><a href="#/lessons">Lessons</a>\n                </li>\n                <li ng-show="$parent.globals.currentUser"><a\n                        href="#/quiz">Quiz</a>\n                </li>\n                <li ng-show="$parent.globals.currentUser"><a\n                        href="#/live_quiz">Live Quiz</a>\n                </li>\n                <li><a href="#/about">About</a>\n                </li>\n\n\n                <li class="divider-vertical"\n                    ng-show="$parent.globals.currentUser && $parent.globals.currentUser.admin"></li>\n\n                <li class="dropdown"\n                    ng-show="$parent.globals.currentUser && $parent.globals.currentUser.mentor">\n                    <a class="dropdown-toggle"\n                       data-toggle="dropdown">Overview</a>\n                    <ul class="dropdown-menu">\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/seats_overview">Seats</a>\n                        </li>\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/overview_lesson">Lesson</a>\n                        </li>\n\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/overview_quiz">Quiz</a>\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/overview_live_quiz">Live Quiz</a>\n                    </ul>\n                </li>\n\n                <li class="dropdown"\n                    ng-show="$parent.globals.currentUser && $parent.globals.currentUser.mentor">\n                    <a class="dropdown-toggle"\n                       data-toggle="dropdown">Manage</a>\n                    <ul class="dropdown-menu">\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/question_list">Question: List &\n                            Manage</a>\n                        </li>\n                        <li ng-show="$parent.globals.currentUser"><a\n                                href="#/question_create">Question: Create</a>\n                        </li>\n\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/lessons_new">Lesson: Create</a>\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/lessons_mngt">Lesson: List & Manage</a>\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/create_quiz">Quiz: Create</a>\n                        </li>\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/quiz_mngt">Quiz: List & Manage</a>\n                        </li>\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/create_live_quiz">Live Quiz: Create</a>\n                        </li>\n                        <li ng-show="$parent.globals.currentUser.mentor"><a\n                                href="#/live_quiz_mngt">Live Quiz: List &\n                            Manage</a>\n                        </li>\n\n                    </ul>\n                </li>\n\n                <li ng-hide="$parent.globals.currentUser"><a href="#/login">Login/Register {{ vm.user.email }}</a>\n                </li>\n\n                <li class="dropdown"\n                    ng-show="$parent.globals.currentUser && $parent.globals.currentUser.organiser">\n                    <a class="dropdown-toggle"\n                       data-toggle="dropdown">\n                        <x ng-if="!$parent.globals.currentUser.admin">Organiser</x>\n                        <x ng-if="$parent.globals.currentUser.admin">Admin</x>\n                    </a>\n                    <ul class="dropdown-menu">\n                        <li ng-show="$parent.globals.currentUser.organiser"><a\n                                href="#/review_attendee">Attendee: Review</a>\n                        </li>\n                        <li ng-show="$parent.globals.currentUser.admin"><a\n                                href="#/admin_email">E-mail</a>\n                        </li>\n\n                        <li ng-show="$parent.globals.currentUser.admin"><a\n                                href="#/admin_users">Users</a>\n                        <li ng-show="$parent.globals.currentUser.admin"><a\n                                href="#/admin_config">Config</a>\n                    </ul>\n                </li>\n\n\n                <li ng-show="$parent.globals.currentUser && $parent.globals.currentUser.organiser"\n                    class="divider-vertical"></li>\n\n                <li class="dropdown"\n                    ng-show="$parent.globals.currentUser">\n                    <a class="dropdown-toggle"\n                       data-toggle="dropdown">\n                        {{ $parent.globals.currentUser.name }}\n                        {{ $parent.globals.currentUser.surname }}</a>\n                    <ul class="dropdown-menu">\n                        <li ng-show="$parent.globals.currentUser"><a\n                                href="#/profile">My Profile</a>\n                        </li>\n                        <li ng-show="$parent.globals.currentUser"><a\n                                href="#/profile_edit">Edit Profile</a>\n                        </li>\n                        <li ng-show="$parent.globals.currentUser"><a\n                                href="#/seats">Seats</a>\n                        </li>\n\n                        <li ng-show="$parent.globals.currentUser"><a\n                                href="#/attendance">Attendance</a>\n                    </ul>\n                </li>\n\n                <li ng-show="$parent.globals.currentUser"><a\n                        ng-click="logout()" target="_self">&#10006;</a>\n                </li>\n            </ul>\n        </div>\n    </div>\n</nav>\n');
$templateCache.put('partials/home.html','<div class="section-colored text-center">\n    <div class="container">\n        <div class="row">\n            <div class="col-lg-12">\n                <h1>PyLadies.Start():</h1>\n                <h2>Bezp\u0142atny warsztat programowania w Pythonie dla\n                    pocz\u0105tkuj\u0105cych.</h2>\n            </div>\n        </div>\n    </div>\n</div>\n\n<div class="section">\n    <div class="container">\n        <div class="row">\n            <div class="col-lg-6 col-md-6">\n                <h3><i class="fa fa-calendar"></i> Kiedy?</h3>\n                <h2>23-24 wrze\u015Bnia 2017</h2>\n                <p>Zaj\u0119cia b\u0119d\u0105 trwa\u0142y pe\u0142ne dwa dni (od 9:00 do 18:00) i\n                    poprowadz\u0105 je do\u015Bwiadczeni mentorzy \u2013 programi\u015Bci\n                    Pythona.</p>\n            </div>\n            <div class="col-lg-6 col-md-6">\n                <h3><i class="fa fa-location-arrow"></i> Gdzie?</h3>\n                <h2>W Poznaniu!</h2>\n                <p>Nauczymy Was podstaw Pythona i wsp\xF3lnie, na bie\u017C\u0105co,\n                    b\u0119dziemy \u0107wiczy\u0107 nowo nabywane umiej\u0119tno\u015Bci. Chcemy, aby\n                    uczestnicy do\u0142\u0105czyli nast\u0119pnie do naszych cotygodniowych\n                    spotka\u0144 PyTrening 4.0, kt\xF3re b\u0119d\u0105 odbywa\u0142y si\u0119 w roku\n                    akademickim 2017/2018 w Poznaniu. B\u0119dziemy na nich dalej\n                    szlifowali i rozwijali znajomo\u015B\u0107 j\u0119zyka Python. </p>\n            </div>\n        </div>\n    </div>\n</div>\n\n\n<div class="section-colored">\n    <div class="container">\n        <div class="row">\n            <div class="col-lg-4 col-md-4">\n                <h3><i class="fa fa-check-circle"></i> Sta\u017Ce i praktyki</h3>\n                <p>Dla najlepszych uczestniczek/uczestnik\xF3w czekaj\u0105 p\u0142atne\n                    sta\u017Ce i praktyki u naszych partner\xF3w.</p>\n            </div>\n            <div class="col-lg-4 col-md-4">\n                <h3><i class="fa fa-pencil"></i>Materia\u0142y po polsku</h3>\n                <p> Nasi mentorzy przygotowuj\u0105 materia\u0142y w formie lekcji,\n                    \u0107wicze\u0144, zada\u0144 domowych i pyta\u0144 sprawdzaj\u0105cych w j\u0119zyku\n                    polskim.</p>\n            </div>\n            <div class="col-lg-4 col-md-4">\n                <h3><i class="fa fa-folder-open"></i>Spo\u0142eczno\u015B\u0107</h3>\n                <p>Dzi\u0119ki tym warsztatom macie szans\u0119 do\u0142\u0105czy\u0107 do gron\n                    programist\xF3w j\u0119zyka Python, zdaniem wielu najbardziej\n                    otwartej spo\u0142eczno\u015Bci programist\xF3w na \u015Bwiecie.</p>\n            </div>\n        </div>\n    </div>\n</div>\n\n\n<div class="section">\n\n    <div class="container">\n\n        <div class="row">\n            <div class="col-lg-12 text-center">\n                <h2>Zdj\u0119cia z trzeciej edycji Pyladies Pozna\u0144</h2>\n                <hr>\n            </div>\n            <div class="col-lg-4 col-md-4 col-sm-6">\n                <img class="img-responsive img-home-portfolio"\n                     src="images/home_0001.jpg">\n            </div>\n            <div class="col-lg-4 col-md-4 col-sm-6">\n                <img class="img-responsive img-home-portfolio"\n                     src="images/home_0002.jpg">\n            </div>\n            <div class="col-lg-4 col-md-4 col-sm-6">\n                <img class="img-responsive img-home-portfolio"\n                     src="images/home_0003.jpg">\n            </div>\n            <div class="col-lg-4 col-md-4 col-sm-6">\n                <img class="img-responsive img-home-portfolio"\n                     src="images/home_0004.jpg">\n            </div>\n            <div class="col-lg-4 col-md-4 col-sm-6">\n                <img class="img-responsive img-home-portfolio"\n                     src="images/home_0005.jpg">\n            </div>\n            <div class="col-lg-4 col-md-4 col-sm-6">\n                <img class="img-responsive img-home-portfolio"\n                     src="images/home_0006.jpg">\n            </div>\n        </div>\n\n\n    </div>\n\n\n</div>\n\n\n<div class="section-colored">\n\n    <div class="container">\n\n        <div class="row">\n            <div class="col-lg-6 col-md-6 col-sm-6">\n                <h2>Warunki uczestnictwa:</h2>\n                <p>W warsztacie mo\u017Ce wzi\u0105\u0107 udzia\u0142 ka\u017Cdy, niezale\u017Cnie od p\u0142ci,\n                    wieku (16+), wykszta\u0142cenia, czy wykonywanego zawodu.\n                    Konieczne s\u0105:</p>\n                <ul>\n                    <li>W\u0142asny laptop</li>\n                    <li>Zainstalowane \u015Brodowisko <a\n                            href="https://www.youtube.com/watch?v=0d6znPZb3PQ&t=3s">(instrukcja)</a>\n                    </li>\n                    <li>Przej\u015Bcie <a\n                            href="https://pyladiesstart.pl/#/register">rekrutacji</a>\n                    </li>\n                    <li>Podstawowa znajomo\u015B\u0107 j\u0119zyka angielskiego. <i>(Warsztaty\n                        b\u0119d\u0105 prowadzone w j\u0119zyku polskim, jednak\u017Ce dla\n                        opanowania sk\u0142adni j\u0119zyka Python znajomo\u015B\u0107 j\u0119zyka\n                        angielskiego b\u0119dzie niew\u0105tpliwie pomocna)</i>\n                </ul>\n                <p>Dodatkowo prosimy o zaopatrzenie si\u0119 we w\u0142asnym zakresie w\n                    jedzenie, kt\xF3rym b\u0119dziecie mogli si\u0119 podzieli\u0107 z innymi\n                    uczestnikami. Zapewniamy jedynie ciep\u0142e i ch\u0142odne\n                    napoje.</p>\n                <p>Potrzebujemy tak\u017Ce u\u017Cyczenia listew zasilaj\u0105cych,\n                    najch\u0119tniej 5- lub 6-gniazdowych. Prosimy o Wasze wsparcie\n                    i deklaracj\u0119 w tej sprawie podczas rejestracji.</p>\n                <h3>Rejestracja zosta\u0142a zako\u0144czona!</h3>\n            </div>\n            <div class="col-lg-6 col-md-6 col-sm-6">\n                <img class="img-responsive" src="images/home_0007.jpg">\n            </div>\n        </div>\n\n\n    </div>\n\n\n</div>\n\n\n<div class="section">\n\n    <div class="container">\n\n        <div class="row">\n            <div class="col-lg-6 col-md-6 col-sm-6">\n                <img class="img-responsive" src="images/home_0008.jpg">\n            </div>\n            <div class="col-lg-6 col-md-6 col-sm-6">\n                <h2>Zapraszamy!</h2>\n                <h3>Poznaj j\u0119zyk, poznaj nowych ludzi, rozruszaj sw\xF3j m\xF3zg,\n                    otw\xF3rz sobie drog\u0119 do kariery w IT!</h3>\n            </div>\n        </div>\n\n\n    </div>\n\n\n</div>\n\n<div class="section-colored">\n    <div class="container">\n        <h1>Partner strategiczny</h1>\n        <div class="row">\n            <div class="col-lg-4 col-md-4">\n                <img class="img-responsive"\n                     src="https://www.python.org/static/img/psf-logo.png">\n            </div>\n            <div class="col-lg-8 col-md-8">\n                <h3>Python Software Foundation (PSF)</h3>\n                <p></p>\n                <p class="text-justify">Chcieliby\u015Bmy serdecznie podzi\u0119kowa\u0107\n                    naszemu partnerowi strategicznemu, Python Software\n                    Foundation, za pomoc oraz ogromne wsparcie w organizacji\n                    warsztat\xF3w weekendowych.\n                </p>\n                <p class="text-justify">Python Software Foundation (PSF) to\n                    organizacja za\u0142o\u017Cona 6 marca 2001 roku. Ich misj\u0105 jest\n                    promowanie, ochrona i rozw\xF3j j\u0119zyka Python oraz wspieranie\n                    mi\u0119dzynarodowej spo\u0142eczno\u015Bci programist\xF3w pisz\u0105cych w tym\n                    j\u0119zyku. Fundacja PSF jest odpowiedzialna za nadzorowanie\n                    proces\xF3w odbywaj\u0105cych si\u0119 w ramach tej\u017Ce spo\u0142eczno\u015Bci,\n                    takich jak rozwijanie g\u0142\xF3wnej dystrybucji j\u0119zyka Python,\n                    zarz\u0105dzanie prawami oraz pozyskiwanie funduszy. Opr\xF3cz tego\n                    PSF zajmuje upowszechnianiem, promocj\u0105 i wspieraniem\n                    dzia\u0142a\u0144 maj\u0105cych na celu rozw\xF3j zasob\xF3w edukacyjnych oraz\n                    technologii zwi\u0105zanych z j\u0119zykiem Python.\n                    W 2005 roku Python Software Foundation zosta\u0142o nagrodzone\n                    za sw\xF3j wk\u0142ad w nowoczesne technologie presti\u017Cow\u0105 nagrod\u0105\n                    Horizon, przyznawan\u0105 przez Computerworld.</p>\n            </div>\n        </div>\n    </div>\n</div>\n\n<div class="section">\n    <div class="container">\n        <h1>Sponsorzy i partnerzy Z\u0142oci</h1>\n        <div class="row">\n            <div class="col-lg-4 col-md-4">\n                <h3>F-Secure</h3>\n                <img class="img-responsive"\n                     src="https://www.f-secure.com/documents/assets/images/logo-f-secure-black.svg">\n                <p class="text-justify">\n                    F-Secure Polska zadeklarowa\u0142o si\u0119 si\u0119 \u017Ce przyjmie\n                    przynajmniej <b> jedn\u0105\n                    osob\u0119 p\u0142atny na sta\u017C</b> w Poznaniu! To ta sama firma,\n                    gdzie ju\u017C w tym\n                    roku trafi\u0142y na sta\u017C dwie nasze PyLadies z trzeciej\n                    edycji, i sk\u0105d mamy wielu mentor\xF3w!\n\n                </p>\n                <p class="text-justify">Oto to co pisz\u0105 o sobie:<br>\n                    F-Secure to firma, kt\xF3ra wprowadza innowacje w\n                    dziedzinie cyberbezpiecze\u0144stwa, chroni\u0105c dziesi\u0105tki\n                    tysi\u0119cy firm i miliony u\u017Cytkownik\xF3w. Wykorzystuje swoje\n                    ogromne do\u015Bwiadczenie, aby chroni\u0107 przedsi\u0119biorstwa i\n                    konsument\xF3w przed wszelkimi zagro\u017Ceniami - od\n                    zaawansowanych cyberatak\xF3w i narusze\u0144 bezpiecze\u0144stwa\n                    danych po powszechne ataki ransomware. Eksperci firmy\n                    pracuj\u0105 w wielu laboratoriach bezpiecze\u0144stwa na\n                    \u015Bwiecie, tworz\u0105c sp\xF3jne podej\u015Bcie okre\u015Blane jako Live\n                    Security. Specjali\u015Bci ds. zabezpiecze\u0144 z F-Secure\n                    uczestniczyli w wi\u0119kszej liczbie dochodze\u0144 zwi\u0105zanych z\n                    cyberprzest\u0119pczo\u015Bci\u0105, ni\u017C pracownicy innych firm na\n                    rynku.\n                    Dla F-Secure cyberbezpiecze\u0144stwo to wi\u0119cej ni\u017C produkt,\n                    to spos\xF3b postrzegania \u015Bwiata. Z produkt\xF3w tej firmy\n                    korzystaj\u0105 dziesi\u0105tki milion\xF3w konsument\xF3w i ponad 100\n                    000 klient\xF3w biznesowych na ca\u0142ym \u015Bwiecie.\n                    F-Secure to firma za\u0142o\u017Cona 1988 roku, zatrudniaj\u0105ca\n                    ponad 1000 pracownik\xF3w w 25 biurach na ca\u0142ym \u015Bwiecie.\n                    Jest notowana na gie\u0142dzie NASDAQ OMX Helsinki Ltd.\n                    <br>\n                    <a href="https://www.f-secure.com">F-Secure</a>\n                </p>\n            </div>\n            <div class="col-lg-4 col-md-4">\n                <h3>Egnyte</h3>\n                <img class="img-responsive"\n                     src="https://www.egnyte.com/assets/6/images/logos/egnyte-lightbg-hirespng.png">\n                <p class="text-justify">\n                    <a href="https://www.egnyte.com">EGNYTE Poland</a> opr\xF3cz\n                    wsparcia finasowego zadeklarowa\u0142 si\u0119, \u017Ce\n                    przyjmie przynajmniej <b>2 uczestniczki na p\u0142atny sta\u017C</b>\n                    po zako\u0144czeniu ca\u0142ego programu warszat\xF3w!\n                </p>\n                <p class="text-justify"> Oto kilka s\u0142\xF3w o Nich:<br>\n                    Zesp\xF3\u0142 Egnyte Poland w Poznaniu tworzy rozwi\u0105zania, dzi\u0119ki\n                    kt\xF3rym mo\u017Cna \u0142atwo, bezpiecznie i inteligentnie udost\u0119pnia\u0107\n                    pliki za pomoc\u0105 chmury lub w\u0142asnej infrastruktury. W\n                    telegraficznym skr\xF3cie to elastyczno\u015B\u0107, przejrzysto\u015B\u0107 i\n                    kontrola nad obs\u0142ug\u0105 plik\xF3w, pozwalaj\u0105ca na wsp\xF3\u0142prac\u0119\n                    pomi\u0119dzy pracownikami danej organizacji, jak r\xF3wnie\u017C\n                    osobami z zewn\u0105trz. Od 2012 roku Egnyte posiada centrum R&D\n                    w Poznaniu na ulicy Mostowej. Zesp\xF3\u0142 liczy sobie ju\u017C ponad\n                    100 os\xF3b... i ci\u0105gle ro\u015Bnie! Nasz\u0105 platform\u0119 tworzymy przy\n                    wykorzystujac takie technologie jak Python, Java czy\n                    JavaScript. W pozna\u0144skim biurze pracuj\u0105 tak\u017Ce In\u017Cynierowie\n                    DevOps, In\u017Cynierowie Danych, In\u017Cynierowie Test\xF3w, jak i\n                    Projektanci Grafiki oraz Interfejsu U\u017Cytkownika. Do\n                    zobaczenia na warsztatach!\n                    <br>\n                    <a href="https://www.facebook.com/EgnytePoland">Egnyte na\n                        Facebook</a>\n                </p>\n            </div>\n\n            <div class="col-lg-4 col-md-4">\n                <h3>Sii Polska</h3>\n                <img class="img-responsive"\n                     src="https://mlodziwlodzi.pl/wp-content/uploads/2014/04/Logo-Sii.jpg"\n                     style="max-height: 120px">\n                <p class="text-justify">\n                    Sii wspar\u0142o nas finansowo!\n                </p>\n                <p class="text-justify"> Oto, co pisz\u0105 o sobie:<br>\n                    Zatrudniaj\u0105c ponad 3000 in\u017Cynier\xF3w, Sii jest liderem us\u0142ug\n                    IT i in\u017Cynierii w Polsce. Realizujemy projekty dla\n                    wiod\u0105cych firm z Polski i z zagranicy. Wspieramy naszych\n                    Klient\xF3w w zakresie rozwoju oprogramowania, zarz\u0105dzania\n                    infrastruktur\u0105 IT, test\xF3w, us\u0142ug service desk,\n                    szkoleniowych i in\u017Cynieryjnych. Sii Polska powsta\u0142a w 2006\n                    roku i w ci\u0105gu kilku lat z ma\u0142ej jednoosobowej firmy\n                    przekszta\u0142ci\u0142a si\u0119 w pr\u0119\u017Cnie dzia\u0142aj\u0105ce przedsi\u0119biorstwo,\n                    zatrudniaj\u0105ce obecnie ponad 3000 specjalist\xF3w. \u015Awiadczone\n                    przez Sii us\u0142ugi daj\u0105 naszym klientom wi\u0119ksz\u0105 elastyczno\u015B\u0107,\n                    dzi\u0119ki czemu mog\u0105 szybciej i efektywniej realizowa\u0107 swoje\n                    cele biznesowe. Dbamy o to, aby satysfakcja naszych\n                    Klient\xF3w, a tak\u017Ce pracownik\xF3w by\u0142a wy\u017Csza ni\u017C u\n                    konkurencji. Pozycj\u0119 lidera na rynku IT w Polsce\n                    zawdzi\u0119czamy konsekwencji w realizacji naszej strategicznej\n                    misji, 5 jasnych cel\xF3w i 15 kluczowych warto\u015Bci, kt\xF3re\n                    odzwierciedlaj\u0105 ducha Sii i panuj\u0105c\u0105 w firmie atmosfer\u0119\n                    <br>\n                    <a href="https://sii.pl/">Sii</a>\n                </p>\n\n\n            </div>\n            <div class="col-lg-4 col-md-4">\n                <h3>Mi\u0119dzynarodowe Targi Pozna\u0144skie</h3>\n                <img class="img-responsive"\n                     src="./images/mtp_logo.jpg"\n                     style="max-height: 120px">\n                <p class="text-justify">\n                    To w\u0142a\u015Bnie tam odp\u0119dzie si\u0119 nasz dwudniowy warsztat!\n                </p>\n                <p class="text-justify"> Oto kilka s\u0142\xF3w o Nich:<br>\n                    MTP liderem polskiego przemys\u0142u targowego.\n                    Jeste\u015Bmy miejscem mi\u0119dzynarodowych spotka\u0144 ludzi my\u015Bl\u0105cych\n                    o przysz\u0142o\u015Bci.\n                    <br>\n                    Mi\u0119dzynarodowe Targi Pozna\u0144skie to lider polskiego\n                    przemys\u0142u targowego. Posiadaj\u0105 ok. 50% udzia\u0142u w rynku\n                    targowym w Polsce i s\u0105 pierwszym organizatorem targ\xF3w w\n                    Europie \u015Arodkowo-Wschodniej. MTP nale\u017C\u0105 do organizacji\n                    skupiaj\u0105cych lider\xF3w targowych z ca\u0142ego \u015Bwiata m.in. UFI -\n                    \u015Awiatowego Stowarzyszenia Przemys\u0142u Targowego i Centrex -\n                    Mi\u0119dzynarodowego Zwi\u0105zku Statystyk Targowych, EMECA -\n                    Europejskiego Stowarzyszenia G\u0142\xF3wnych Centr\xF3w\n                    Wystawienniczych oraz Polskiej Izby Przemys\u0142u Targowego.\n                    <br>\n                    <a href="http://www.mtp.pl/">MTP</a>\n                </p>\n\n            </div>\n        </div>\n    </div>\n\n\n    <div class="section-colored">\n        <div class="container">\n            <h1>Sponsorzy i partnerzy Srebrni</h1>\n            <div class="row">\n                <div class="col-lg-4 col-md-4">\n                    <h3></i>Tandem Pub | Tandem Studio</h3>\n                    <img class="img-responsive"\n                         src="https://www.pitupitu.pl/files/HZpEDn0OZ0Xs3wGLlDCj4HDIzRY/big">\n                    <p class="text-justify">\n                        Chcieliby\u015Bmy serdecznie podzi\u0119kowa\u0107 pubowi Tandem za\n                        udzielon\u0105 nam pomocy przy organizacji szkole\u0144 dla\n                        mentor\xF3w\n                        oraz afterparty zaplanowanego po kursie.\n                    </p>\n                    <p class="text-justify">\n                        Tandem pub jest miejscem, oferuj\u0105cym szeroki wyb\xF3r piw,\n                        alkoholi i przek\u0105sek, gdzie mo\u017Cna mi\u0142o sp\u0119dzi\u0107 czas ze\n                        znajomymi, a tak\u017Ce uczy\u0107 si\u0119 j\u0119zyk\xF3w obcych na\n                        organizowanych tam warsztatach j\u0119zykowych. Oferuj\u0105\n                        wyj\u0105tkow\u0105 atmosfer\u0119, w kt\xF3rej mo\u017Cna si\u0119 odpr\u0119\u017Cy\u0107.\n                        Organizuj\u0105 te\u017C spotkania podr\xF3\u017Cnicze, gdzie mo\u017Cna\n                        pos\u0142ucha\u0107\n                        o r\xF3\u017Cnych zak\u0105tkach \u015Bwiata.\n                        Tu\u017C obok znajduje si\u0119 Tandem Studio, wyj\u0105tkowa\n                        przestrze\u0144\n                        stworzona do organizacji wszelkiego rodzaju wydarze\u0144,\n                        wystaw i imprez, r\xF3wnie\u017C zamkni\u0119tych. Tandem Studio\n                        jest\n                        miejscem, w kt\xF3rym mo\u017Cna poczu\u0107 si\u0119 jak w domu. Podczas\n                        organizacji wydarze\u0144 mo\u017Cna korzysta\u0107 z szeregu\n                        udogodnie\u0144,\n                        takich jak: aneks kuchenny, niezale\u017Cne nag\u0142o\u015Bnienie,\n                        projektor, Internet, zabawki dla dzieci.\n                    </p>\n                </div>\n\n                <div class="col-lg-4 col-md-4">\n                    <h3>Pearson IOKI</h3>\n                    <img class="img-responsive"\n                         src="./images/pearson_logo.png"\n                         style="max-height: 120px">\n                    <p>\n                        Pearson IOKI to blisko 200-osobowy zesp\xF3\u0142, kt\xF3ry z pasj\u0105\n                        i zaanga\u017Cowaniem zajmuje si\u0119 tworzeniem platform\n                        e-learningowych o og\xF3lno\u015Bwiatowym zasi\u0119gu.\n                        <br>\n                        Mi\u0142o\u015Bnik\xF3w Pythona znajdziecie w Pearsonie zespole\n                        back-end, kt\xF3ry skupia najlepszych ekspert\xF3w w\n                        dziedzinie in\u017Cynierii oprogramowania. Ich\n                        g\u0142\xF3wnym zadaniem jest budowanie wydajnych,\n                        skalowalnych i stabilnych platform dla\n                        u\u017Cytkownik\xF3w na ca\u0142ym \u015Bwiecie. Poza Pythonem,\n                        programuj\u0105 oni w Java, PHP (Symfony 2), C# i\n                        nodeJS przy u\u017Cyciu baz danych My\xADSQL, MSSQL,\n                        MongoDB.\n                        <br>\n                        Poza back-endem, dzia\u0142 IT w Pearson IOKI obejmuje\n                        r\xF3wnie\u017C Front-end, Quality assurance oraz DevOps.\n                        <br>\n                        <a href="https://ioki.pl/">Pearson IOKI</a>\n                    </p>\n                </div>\n\n                <div class="col-lg-4 col-md-4">\n                    <h3>Allegro</h3>\n                    <img class="img-responsive"\n                         src="./images/allegrologo.jpg"\n                         style="max-height: 120px">\n                    <p>\n                        Allegro to ulubione miejsce zakup\xF3w dla oko\u0142o 14\n                        milion\xF3w u\u017Cytkownik\xF3w miesi\u0119cznie; codziennie sprzedaje\n                        si\u0119 tu ponad 750 tysi\u0119cy przedmiot\xF3w. Jeste\u015Bmy przede\n                        wszystkim platform\u0105 handlow\u0105, na kt\xF3rej firmy wystawiaj\u0105\n                        swoje produkty na sprzeda\u017C, ale r\xF3wnie\u017C oferujemy\n                        mo\u017Cliwo\u015B\u0107 wzi\u0119cia udzia\u0142u w licytacjach. W 2015 r.\n                        rozpocz\u0119li\u015Bmy dzia\u0142alno\u015B\u0107 w obszarze e-tail: wci\u0105\u017C\n                        rozwijamy w\u0142asny sklep internetowy, rozszerzaj\u0105c stopie\u0144\n                        z\u0142o\u017Cono\u015Bci i skal\u0119 naszej platformy. Allegro staje si\u0119\n                        coraz bardziej mobilne: miesi\u0119cznie odnotowujemy ponad\n                        47 milion\xF3w zapyta\u0144 do wyszukiwarki w urz\u0105dzeniach\n                        mobilnych, w kt\xF3rych codziennie sprzedaje si\u0119 ponad 130\n                        tysi\u0119cy przedmiot\xF3w.\n                        <br>\n                        W Allegro tworzymy i utrzymujemy aplikacje, kt\xF3re dzi\u0119ki\n                        swojej skalowalno\u015Bci i niezawodno\u015Bci zyska\u0142y sobie\n                        rzesz\u0119 wiernych u\u017Cytkownik\xF3w w ca\u0142ej Europie\n                        \u015Arodkowo-Wschodniej. Zadanie nie nale\u017Cy do\n                        naj\u0142atwiejszych, w pracy napotykamy na szereg wyzwa\u0144\n                        zar\xF3wno w obszarze samej architektury i designu, jak i w\n                        procesie doboru technologii, zapewnienia jako\u015Bci kodu,\n                        usprawnienia funkcjonalno\u015Bci oraz w p\xF3\u017Aniejszej fazie\n                        wdro\u017Cenia i utrzymania produktu.\n                        allegro.tech jest naszym pomys\u0142em na dzielenie si\u0119\n                        zebranym do\u015Bwiadczeniem poprzez organizacj\u0119 konferencji,\n                        warsztat\xF3w, meetup\xF3w i hackaton\xF3w.\n                        Po wi\u0119cej informacji zapraszamy na <a\n                            href="http://www.allegro.tech">blog</a> oraz <a\n                            href="https://www.facebook.com/allegro.tech">FB</a>\n                    </p>\n                </div>\n\n                <div class="col-lg-4 col-md-4">\n                    <h3>Synology</h3>\n                    <img class="img-responsive"\n                         src="./images/Synology_logo.jpg"\n                         style="max-height: 120px">\n                    <p>\n                        Synology produkuje rozwi\u0105zania sieciowej pami\u0119ci masowej\n                        (NAS) oraz monitoringu IP, kt\xF3re zmieniaj\u0105 spos\xF3b, w\n                        jaki u\u017Cytkownicy zarz\u0105dzaj\u0105 danymi i realizuj\u0105 zadania\n                        zwi\u0105zane z nadzorem w erze przetwarzania w chmurze. W\n                        pe\u0142ni wykorzystuj\u0105c zalety najnowszych technologii,\n                        firma Synology zapewnia u\u017Cytkownikom niezawodne i\n                        przyst\u0119pne cenowo rozwi\u0105zania do centralizacji zasob\xF3w\n                        pami\u0119ci masowych oraz kopii zapasowych, udost\u0119pniania\n                        plik\xF3w na zewn\u0105trz i wdra\u017Cania profesjonalnych rozwi\u0105za\u0144\n                        nadzoru wizyjnego. Synology stawia sobie za cel\n                        oferowanie produkt\xF3w o przysz\u0142o\u015Bciowych funkcjach oraz\n                        najlepszych w swojej klasie us\u0142ug dla klient\xF3w.\n                        <br>\n                        <a href="https://www.synology.com/pl-pl">Synology</a>\n                    </p>\n                </div>\n            </div>\n        </div>\n    </div>\n\n\n    <div class="section">\n        <div class="container">\n            <h1>Sponsorzy i partnerzy Br\u0105zowi</h1>\n            <div class="row">\n                <div class="col-lg-4 col-md-4">\n                    <h3>\n                        Stowarzyszenie Polska Grupa U\u017Cytkownik\xF3w Pythona (PLPUG)\n                    </h3>\n                    <img class="img-responsive"\n                         src="./images/logotyp_plpug.png"\n                         style="max-height: 120px">\n                    <p>\n                        Celem PLPUG jest:\n                    <ul>\n                        <li>\n                            Budowa i integracja polskiej spo\u0142eczno\u015Bci\n                            wykorzystuj\u0105cej j\u0119zyk programowania Python\n                        </li>\n                        <li>\n                            Rozw\xF3j, popularyzacja i promocja Pythona, jak\n                            r\xF3wnie\u017C zwi\u0105zanego z nim oprogramowania na polskiej\n                            oraz mi\u0119dzynarodowej arenie informatycznej,\n                        </li>\n                        <li>\n                            Reprezentowanie cz\u0142onk\xF3w Stowarzyszenia, ich opinii\n                            i potrzeb,\n                        </li>\n                        <li>\n                            Wsp\xF3\u0142praca i wspieranie lokalnych oraz\n                            mi\u0119dzynarodowych grup u\u017Cytkownik\xF3w Pythona, a tak\u017Ce\n                            innych spo\u0142eczno\u015Bci wykorzystuj\u0105cych ten j\u0119zyk\n                            programowania,\n                        </li>\n                        <li>\n                            Wspieranie projekt\xF3w zwi\u0105zanych z Pythonem,\n                        </li>\n                        <li>\n                            Wspieranie rozwoju rynku pracy dla programist\xF3w\n                            Pythona,\n                        </li>\n                        <li>\n                            Dzia\u0142alno\u015B\u0107 na rzecz o\u015Bwiaty, szkolnictwa i\n                            edukacji.\n                        </li>\n                    </ul>\n                    Wi\u0119cej informacji dotycz\u0105cych dzia\u0142a\u0144 i wydarze\u0144 mo\u017Cna\n                    znale\u017A\u0107 na:\n                    <a href="https://plpug.org/">PLPUG</a>\n                    </p>\n                </div>\n                <div class="col-lg-4 col-md-4">\n                    <h3>\n                        Kids Code Fun\n                    </h3>\n                    <img class="img-responsive"\n                         src="./images/KCF_logo.png"\n                         style="max-height: 120px">\n                    <p>\n                        Uczymy dzieci j\u0119zyka przysz\u0142o\u015Bci. Co to znaczy?\n\n                        Zapewniamy dzieciom i m\u0142odzie\u017Cy nowoczesn\u0105 edukacj\u0119 w\n                        dziedzinie nowych technologii. Dzia\u0142amy w Warszawie i\n                        Poznaniu, nieustannie si\u0119 rozwijaj\u0105c. Zapewniamy zaj\u0119cia\n                        dla dzieci i m\u0142odzie\u017Cy od 5 do 16 roku \u017Cycia. Prowadzimy\n                        r\xF3\u017Cnorodne kursy, kt\xF3re pozwalaj\u0105 naszym podopiecznym\n                        rozwija\u0107 cyfrowe zainteresowania, szczeg\xF3lnie w obszarze\n                        programowania. Nasze dzia\u0142ania rozbudzaj\u0105 wewn\u0119trzn\u0105\n                        ciekawo\u015B\u0107 i dociekliwo\u015B\u0107 m\u0142odych odkrywc\xF3w.\n\n                        Pokazujemy cyfrowy \u015Bwiat przez programowanie oraz\n                        tworzenie animacji w j\u0119zyku Scratch, projektowanie gier\n                        czy budowanie stron www. Razem z dzie\u0107mi programujemy z\n                        robotami Dash, uczymy grafiki komputerowej, budowania\n                        aplikacji mobilnych i 3D Design. Organizujemy zaj\u0119cia\n                        semestralne i warsztaty ale lubimy anga\u017Cowa\u0107 si\u0119 te\u017C w\n                        inne cyfrowe projekty.\n\n                        Nieustaj\u0105co wspieramy naszego partnera - Fundacj\u0119 Girls\n                        Code Fun, zach\u0119caj\u0105c\u0105 dziewcz\u0119ta do rozwoju w\n                        dziedzinach STEM (Science, Technology, Engineering,\n                        Math).\n                        <br>\n                        <a href="http://kidscodefun.com/">Kids Code Fun</a>\n                    </p>\n                </div>\n                <div class="col-lg-4 col-md-4">\n                    <h3><i class="fa fa-check-circle"></i> Tu mo\u017Cesz znale\u017A\u0107\n                        si\u0119 i\n                        Ty</h3>\n                    <p>Napisz do nas, a ch\u0119tnie prze\u015Blemy Ci ofert\u0119\n                        wsp\xF3\u0142pracy</p>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <div class="section-colored">\n        <div class="container">\n            <h1>Patroni medialni</h1>\n            <div class="row">\n                <div class="col-lg-4 col-md-4">\n                    <h3>bulldogjob.com</h3><br>\n                    <img class="img-responsive"\n                         src="https://cdn2.bulldogjob.com/assets/logo-6d85aa7138552c5b466f9a4fb26785893cceb34e7b344915bba0392dd125287a.png">\n                    <br>\n                    <p>\n                        Bulldogjob.pl to miejsce promuj\u0105ce \u015Bwiadome podej\u015Bcie\n                        pracodawc\xF3w IT do miejsca pracy jakie tworz\u0105. S\u0105 tam\n                        wysokiej jako\u015Bci og\u0142oszenia ale i artyku\u0142y pracodawc\xF3w\n                        IT. Firmy w ten spos\xF3b dziel\u0105 si\u0119 swoim do\u015Bwiadczeniem i\n                        wiedz\u0105 z tego obszaru. Bulldogjob pokazuje najlepszych\n                        pracodawc\xF3w IT pokazuj\u0105c ich metodologi\u0119 pracy, ich\n                        rozwi\u0105zania technologiczne i osi\u0105gni\u0119cia. Portal ten\n                        u\u0142atwia wyb\xF3r dobrego miejsca pracy w IT.\n                    </p>\n                </div>\n                <div class="col-lg-4 col-md-4">\n                    <h3>Mamstartup</h3>\n                    <img class="img-responsive"\n                         src="http://mamstartup.pl/i/layout_v2/mslogo2.svg">\n                    <br>\n                    <p>Jedyny polski magazyn w pe\u0142ni po\u015Bwi\u0119conym startupom\n                        internetowym</p>\n                </div>\n\n\n                <div class="col-lg-4 col-md-4">\n                    <h3>Lepszy Pozna\u0144</h3>\n                    <img class="img-responsive"\n                         src="http://szczecin.24q.info/wp-content/uploads/2015/05/logoLPwhite.png">\n                    <br>\n                    <p>pierwszy portal metropolii Pozna\u0144, na kt\xF3rym znajdziecie\n                        zapowiedzi najciekawszych imprez kulturalnych. Pisz\u0105 o\n                        dzia\u0142aj\u0105cych w regionie firmach i relacjonuj\u0105\n                        wydarzenia sportowe. Polityka nie pojawia si\u0119 na\n                        stronach portalu.</p>\n                </div>\n            </div>\n        </div>\n    </div>\n');
$templateCache.put('partials/lessons.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Lessons</h1>\n    </div>\n    <div class="row">\n        <div class="col-lg-12">\n            <div class="panel-group" id="accordion">\n                <div class="panel panel-default" ng-repeat="x in vm.lessons">\n                    <div class="panel-heading">\n                        <h4 class="panel-title">\n                            <a class="accordion-toggle" data-toggle="collapse" target="_self"\n                               data-parent="#accordion"\n                               href="#collapse_{{ x.id }}">\n                               {{ x.id }}.  {{ x.title }}\n                            </a>\n                        </h4>\n                    </div>\n                    <div id="collapse_{{ x.id }}" class="panel-collapse collapse">\n                        <div class="panel-body">\n                            {{ x.description }}\n                            <br>\n                            <br>\n                            <a href="#/lesson/{{ x.full_id }}" class="btn btn-xs btn-success">Start !</a>\n                        </div>\n                    </div>\n                </div>\n\n\n\n            </div>\n\n        </div>\n\n    </div>\n\n</div>\n</div>\n');
$templateCache.put('partials/lessons_mngt.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Lessons: Management</h1>\n    </div>\n     <div class="col-sm-6" ng-repeat="less in vm.lessons">\n        <div class="panel panel-default text-left">\n            <div class="panel-heading">\n                <strong>{{ less.id }}: {{ less.title }} </strong>   <a href="#/lesson/{{ less.id }}" class="btn btn-xs btn-primary">Show</a>\n            </div>\n            <ul class="list-group">\n                <li class="list-group-item">\n                   <b>Description:</b><br>\n                    {{ less.description }}\n                </li>\n                <li class="list-group-item">\n                   <b>Author:</b>\n                    {{ less.author }}\n                </li>\n                <li class="list-group-item" ng-if="less.quiz">\n                   <b>Quiz:</b>\n                    {{ less.quiz }}\n                </li>\n                <li class="list-group-item" ng-if="less.live_quiz">\n                   <b>Live Quiz:</b>\n                    {{ less.live_quiz }}\n                </li>\n                <li class="list-group-item">\n                    <text class="bg-success" ng-show="less.active"> Active </text> <text class="bg-warning" ng-hide="less.active"> Not Active </text><br>\n                        <a class="btn btn-success inline" ng-hide="less.active"\n                           ng-show="$parent.globals.currentUser.admin"\n                           ng-click="vm.activate( less.id )">Active</a>\n\n                        <a class="btn btn-danger" ng-show="less.active && $parent.globals.currentUser.admin" class="inline"\n                           ng-click="vm.deactivate( less.id )">Deactivate</a>\n                        <a class="btn btn-warning inline"\n                           ng-show="$parent.globals.currentUser.admin"\n                           ng-click="vm.absence( less.id )">Absence Code</a>\n                    <a class="btn btn-info inline"\n                           ng-show="$parent.globals.currentUser.admin"\n                           ng-click="vm.extend( less.id )">Extend</a>\n                </li>\n            </ul>\n        </div>\n    </div>\n\n\n\n\n</div>\n</div>\n');
$templateCache.put('partials/lessons_new.html','<div class="container">\n\n    <div class="row">\n\n        <div class="col-lg-12">\n            <h1 class="page-header">Create new lesson\n            </h1>\n\n        </div>\n\n    </div>\n\n\n    <form name="form" ng-submit="vm.new_lesson()" role="form">\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.answer.$dirty && form.lastName.$error.required }">\n            <label for="title">Title</label>\n            <input type="text" name="title" id="Text2" class="form-control"\n                   ng-model="vm.lesson.title" required/>\n            <span ng-show="form.lesson.$dirty && form.lesson.$error.required"\n                  class="help-block">Possible Answer</span>\n        </div>\n\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.firstName.$dirty && form.firstName.$error.required }">\n            <label for="description">description</label>\n            <textarea type="text" name="description" id="firstName"\n                      class="form-control" ng-model="vm.lesson.description"\n                      required/></textarea>\n            <span ng-show="form.lesson.$dirty && form.lesson.$error.required"\n                  class="help-block">Description is required</span>\n        </div>\n\n\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.lastName.$dirty && form.lastName.$error.required }">\n            <label for="lesson">Link for presentation</label>\n            <input type="text" name="title" id="Text2" class="form-control"\n                   ng-model="vm.lesson.file" required/>\n            <span ng-show="form.file.$dirty && form.file.$error.required"\n                  class="help-block">Link for presentation is required</span>\n        </div>\n\n        <div class="form-actions">\n            <button type="submit" ng-disabled="form.$invalid || vm.dataLoading"\n                    class="btn btn-primary">Create\n            </button>\n            <img ng-if="vm.dataLoading"\n                 src="data:image/gif;base64,"/>\n        </div>\n    </form>\n\n\n</div>\n');
$templateCache.put('partials/live_quiz.html','<div class="container">\n\n    <div class="row">\n\n        <div class="col-lg-12">\n            <h1 class="page-header">Live Quiz: {{ vm.quiz_title }}\n            </h1>\n        </div>\n\n    </div>\n\n    <div class="col-md-6 col-md-offset-3">\n        <p>\n            {{ vm.question.question }}\n            {{ vm.question.answare }}\n        </p>\n        <form name="form" ng-submit="vm.answare_question()" role="form" ng-hide="vm.question.last">\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.username.$dirty && form.username.$error.required }">\n                <label for="answer">Answer:</label>\n                <input type="text" name="answer" id="answer"\n                       class="form-control" ng-model="vm.answare" required/>\n                <span ng-show="form.answare.$dirty && form.answare.$error.required"\n                      class="help-block">Answer is required</span>\n            </div>\n\n            <div class="form-actions" ng-hide="vm.question.last">\n                <button type="submit"\n                        ng-disabled="form.$invalid || vm.dataLoading"\n                        class="btn btn-primary">Answare\n                </button>\n                <img ng-if="vm.dataLoading"\n                     src="data:image/gif;base64,"/>\n            </div>\n        </form>\n    </div>\n\n</div>\n');
$templateCache.put('partials/live_quiz_create.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Create new Live Quiz\n            </h1>\n        </div>\n    </div>\n    <form name="form" ng-submit="vm.create_quiz()" role="form">\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.answer.$dirty && form.lastName.$error.required }">\n            <label for="title">Title</label>\n            <input type="text" name="title" id="Text2" class="form-control"\n                   ng-model="vm.lesson.title" required/>\n            <span ng-show="form.lesson.$dirty && form.lesson.$error.required"\n                  class="help-block">Title is required</span>\n        </div>\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.firstName.$dirty && form.firstName.$error.required }">\n            <label for="description">description</label>\n            <textarea type="text" name="description" id="firstName"\n                      class="form-control" ng-model="vm.lesson.description"\n                      required/></textarea>\n            <span ng-show="form.lesson.$dirty && form.lesson.$error.required"\n                  class="help-block">Description is required</span>\n        </div>\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.lastName.$dirty && form.lastName.$error.required }">\n            <label for="lesson">Questions:</label>\n            <div class="checkbox" ng-repeat="qiz in vm.questions">\n                <label ><input ng-model="vm.lesson.questions[qiz.id]" type="checkbox" value="{{ qiz.id }}">{{ qiz.question }}</label>\n            </div>\n            <span ng-show="form.file.$dirty && form.file.$error.required"\n                  class="help-block">Link for presentation is required</span>\n        </div>\n        <div class="form-actions">\n            <button type="submit" ng-disabled="form.$invalid || vm.dataLoading"\n                    class="btn btn-primary">Create\n            </button>\n            <img ng-if="vm.dataLoading"\n                 src="data:image/gif;base64,"/>\n        </div>\n    </form>\n</div>\n</div>\n<!-- /.container -->');
$templateCache.put('partials/live_quiz_list.html','<div class="container">\n\n    <div class="row">\n\n        <div class="col-lg-12">\n            <h1 class="page-header">Live Quizes\n                <small>Avalaible quizes</small>\n            </h1>\n        </div>\n\n    </div>\n\n    <div class="row">\n\n        <div class="col-sm-3" ng-repeat="q in vm.live_quzies">\n            <div class="panel panel-default text-center">\n                <div class="panel-heading">\n                    <strong>{{ q.title }}</strong>\n                </div>\n                <div class="panel-body">\n                    <h3 class="panel-title price">{{ q.amount }}\n                        <span class="price-month">questions</span>\n                    </h3>\n                </div>\n                <ul class="list-group">\n                    <li class="list-group-item">{{ q.description }}</li>\n                    <li class="list-group-item">{{ q.creator }}</li>\n                    <li class="list-group-item">\n                        <a class="btn btn-success" ng-click="vm.start( q.id )">Start now !</a>\n                        <a class="btn btn-danger" ng-click="vm.show_results( q.id )">Results</a>\n                    </li>\n                </ul>\n            </div>\n        </div>\n\n    </div>\n\n</div>');
$templateCache.put('partials/live_quiz_results.html','<div class="container">\n\n    <div class="row">\n\n        <div class="col-lg-12">\n            <h1 class="page-header">Live Quizes\n                <small>Avalaible quizes</small>\n            </h1>\n        </div>\n\n    </div>\n\n    <div class="row">\n\n        <div class="col-sm-3" ng-repeat="(name, q) in vm.live_quiz.answares">\n\n\n            <div class="panel panel-default text-center">\n                <div class="panel-heading">\n                    <strong>{{ vm.questions[name] }}</strong>\n                </div>\n                <ul class="list-group">\n                    <li class="list-group-item" ng-repeat="(a, b) in q">{{ a }} : {{ b }}</li>\n                </ul>\n            </div>\n\n\n        </div>\n\n    </div>\n\n</div>');
$templateCache.put('partials/login.html','<div class="container">\n\n    <div class="col-md-6 col-md-offset-3">\n        <h2>Login</h2>\n        <form name="form" ng-submit="vm.login()" role="form">\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.username.$dirty && form.username.$error.required }">\n                <label for="username">E-mail</label>\n                <input type="text" name="username" id="username"\n                       class="form-control" ng-model="vm.username" required/>\n                <span ng-show="form.username.$dirty && form.username.$error.required"\n                      class="help-block">Username is required</span>\n            </div>\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.password.$dirty && form.password.$error.required }">\n                <label for="password">Password</label>\n                <input type="password" name="password" id="password"\n                       class="form-control" ng-model="vm.password" required/>\n                <span ng-show="form.password.$dirty && form.password.$error.required"\n                      class="help-block">Password is required</span>\n            </div>\n            <div class="form-actions">\n                <button type="submit"\n                        ng-disabled="form.$invalid || vm.dataLoading"\n                        class="btn btn-primary">Login\n                </button>\n                <img ng-if="vm.dataLoading"\n                     src="data:image/gif;base64,"/>\n                <a href="#/register" class="btn btn-link">Register</a>\n            </div>\n        </form>\n    </div>\n\n</div>\n<!-- /.container -->');
$templateCache.put('partials/profile.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Profile<br>\n                <small>{{ globals.currentUser.name }} {{ globals.currentUser.surname }}\n                    ({{ globals.currentUser.email }})\n                </small>\n            </h1>\n\n\n            <div class="col-sm-4">\n                <img ng-show="vm.user_profile.img" class="img-responsive"\n                     src="/images/{{ vm.user_profile.img }}">\n                <br>\n                <ul class="list-group">\n                    <li ng-show="vm.user_profile.admin"\n                        class="list-group-item list-group-item-danger">Admin\n                    </li>\n                    <li ng-show="vm.user_profile.organiser"\n                        class="list-group-item list-group-item-warning">\n                        Organiser\n                    </li>\n                    <li ng-show="vm.user_profile.mentor"\n                        class="list-group-item list-group-item-success">Mentor\n                    </li>\n                    <li ng-hide="vm.user_profile.mentor || vm.user_profile.admin || vm.user_profile.organiser"\n                        class="list-group-item list-group-item-info">Attendee\n                    </li>\n                </ul>\n            </div>\n            <div class="col-sm-4">\n                About:\n                <ul class="list-group">\n                    <li class="list-group-item">\n                        <strong>Description: </strong><br>\n                        {{ vm.user_profile.description }}\n                    </li>\n                    <li class="list-group-item">\n                        <strong>Motivation: </strong><br>\n                        {{ vm.user_profile.motivation }}\n                    </li>\n                    <li class="list-group-item"  ng-show="vm.user_profile.app_idea && vm.user_profile.app_idea != \'null\'">\n                        <strong>app_idea: </strong><br>\n                        {{ vm.user_profile.app_idea }}\n                    </li>\n                    <li class="list-group-item">\n                        <strong>What Can you bring and share to eat/drink: </strong><br>\n                        {{ vm.user_profile.what_can_you_bring }}\n                    </li>\n                    <li class="list-group-item"\n                        ng-show="vm.user_profile.i_helped">\n                        <strong>I helped with: </strong><br>\n                        {{ vm.user_profile.helped }}\n                    </li>\n                    <li class="list-group-item">\n                        <strong>City: </strong><br>\n                        {{ vm.user_profile.city }}\n                    </li>\n                    <li class="list-group-item">\n                    <strong>operating_system: </strong><br>\n                    {{ vm.user_profile.operating_system }}\n                </li>\n                </ul>\n                <ul class="list-unstyled list-inline list-social-icons">\n                    <li class="tooltip-social facebook-link"\n                        ng-show="vm.user_profile.facebook && vm.user_profile.facebook != \'null\'"><a\n                            href="{{ vm.user_profile.facebook }}"\n                            data-toggle="tooltip"\n                            data-placement="top"\n                            title="Facebook"><i\n                            class="fa fa-facebook-square fa-2x"></i></a>\n                    </li>\n                    <li class="tooltip-social linkedin-link"\n                        ng-show="vm.user_profile.linkedin && vm.user_profile.linkedin != \'null\'"><a\n                            href="{{ vm.user_profile.linkedin }}"\n                            data-toggle="tooltip"\n                            data-placement="top"\n                            title="LinkedIn"><i\n                            class="fa fa-linkedin-square fa-2x"></i></a>\n                    </li>\n                    <li class="tooltip-social twitter-link"\n                        ng-show="vm.user_profile.twitter && vm.user_profile.twitter != \'null\'"><a\n                            href="{{ vm.user_profile.twitter }}"\n                            data-toggle="tooltip"\n                            data-placement="top"\n                            title="Twitter"><i\n                            class="fa fa-twitter-square fa-2x"></i></a>\n                    </li>\n                </ul>\n            </div>\n            <div class="col-sm-4">\n                Recrutation status:\n                {{ vm.user_profile.confirmation }}\n                <ul class="list-group">\n                    <li ng-show="vm.user_profile.accepted && vm.user_profile.confirmation == \'ack\'"\n                        class="list-group-item list-group-item-success">You\n                        confirmed Your arrival !\n                    </li>\n                    <li ng-show="vm.user_profile.accepted && vm.user_profile.confirmation == \'noans\'"\n                        class="list-group-item list-group-item-danger">You are\n                        accepted but You did not confirmed your arrival yet!\n                    </li>\n                    <li ng-show="vm.user_profile.accepted && vm.user_profile.confirmation == \'rej_user\'"\n                        class="list-group-item list-group-item-warning">You are\n                        accepted but You did not confirmed your arrival in time\n                        or You rejected the invitation!\n                    </li>\n                    <li ng-show="vm.user_profile.accepted && vm.user_profile.confirmation == \'rejected\'"\n                        class="list-group-item list-group-item-warning">Sadly You were not chosen, but there maybe a spot open for you later on.\n                    </li>\n                    <li ng-hide="vm.user_profile.accepted && vm.user_profile.confirmation !== \'rejected\'"\n                        class="list-group-item list-group-item-info">Your\n                        registration is complete.\n                    </li>\n                </ul>\n            </div>\n        </div>\n    </div>\n</div>\n');
$templateCache.put('partials/profile_edit.html','<div class="container" xmlns="http://www.w3.org/1999/html">\n\n    <div class="col-md-6 col-md-offset-3">\n        <h1>{{ vm.user.name }} {{ vm.user.surname }}</h1><small>{{ vm.user.email }}</small>\n        <h3 ng-hide="vm.user.lang === \'pl\'">Language:</h3>\n        <h3 ng-show="vm.user.lang === \'pl\'">J\u0119zyk:</h3>\n        <form name="form" ng-submit="vm.update_user()" role="form">\n            <div class="form-group">\n                <label for="lang">\n                    <input class="form-inline text-left" type="radio"\n                           name="lang" id="lang" value="pl"\n                           ng-model="vm.user.lang"\n                           required/> Polski\n                    <input class="form-inline float-right" type="radio"\n                           name="lang" id="lang" value="en"\n                           ng-model="vm.user.lang"\n                           required/> English\n                </label>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.city.$dirty && form.password.$error.required }">\n                <label for="city" ng-if="vm.user.lang === \'en\'">City</label>\n                <label for="city" ng-if="vm.user.lang === \'pl\'">Miejscowo\u015B\u0107</label>\n                <span ng-show="form.city.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.city.$error.minlength "\n                      class="help-inline alert-danger">Minimal length 3</span>\n                <span ng-show="form.city.$dirty && form.city.$valid" class="help-inline alert-success">&#10003;</span>\n                <span ng-show="form.city.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters</span>\n                <input ng-minlength="3" type="text" name="city" id="city" ng-pattern="/^[a-zA-Z \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                       class="form-control" ng-model="vm.user.city"/>\n            </div>\n\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.description.$dirty && form.description.$error.required }">\n                <label for="description" ng-if="vm.user.lang === \'en\'">Description</label>\n                <label for="description" ng-if="vm.user.lang === \'pl\'">Opis</label>\n                <span ng-show="form.description.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.description.$error.minlength "\n                      class="help-inline alert-danger">Minimal length 65</span>\n                <span ng-show="form.description.$dirty && form.description.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <span ng-show="form.description.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <textarea ng-minlength="65" type="text" name="description"\n                          id="description" class="form-control" ng-pattern="/^[a-zA-Z0-9!:*., \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                          ng-model="vm.user.description" required/>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.t_shirt.$dirty && form.t_shirt.$error.required }">\n                <label for="t_shirt">T-shirt*</label>\n                <span ng-show="form.t_shirt.$error.required" class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.t_shirt.$dirty && form.t_shirt.$valid" class="help-inline alert-success">&#10003;</span>\n                <select class="form-control" ng-options="x for x in [\'Female-XXS\', \'Female-XS\', \'Female-S\', \'Female-M\', \'Female-L\', \'Female-XL\', \'Female-XXL\', \'Female-XXXL\', \'Male-XS\', \'Male-S\', \'Male-M\', \'Male-L\', \'Male-XL\', \'Male-XXL\', \'Male-XXXL\']"\n                        ng-model="vm.user.t_shirt" ngValue="x" required name="t_shirt" id="t_shirt">\n                    <option></option>\n                </select>\n            </div>\n\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.operating_system.$dirty && form.operating_system.$error.required }">\n                <label for="operating_system" ng-if="vm.user.lang === \'en\'">Operating System</label>\n                <label for="operating_system" ng-if="vm.user.lang === \'pl\'">System Operacyjny</label>\n                <span ng-show="form.operating_system.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.operating_system.$dirty && form.operating_system.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <select class="form-control" ng-options="x for x in [\'MacOS\', \'Linux\', \'Windows\']"\n                        ng-model="vm.user.operating_system" ngValue="x" name="operating_system" id="operating_system"\n                        required><option></option>\n                </select >\n            </div>\n\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.experience.$dirty && form.password.$error.required }">\n                <label for="img" ng-if="vm.user.lang === \'en\'">Photo</label>\n                <label for="img" ng-if="vm.user.lang === \'pl\'">Zdjcie</label>\n                <span ng-show="form.img.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <input type="text" name="img" ng-pattern="/^[a-zA-Z0-9!:*\\., :/\\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107]*$/"\n                       id="img" class="form-control"  ng-model="vm.user.img"/>\n            </div>\n\n            <div class="form-group">\n                <label for="linkedin" ng-if="vm.user.lang === \'en\'">Linkedin</label>\n                <label for="linkedin" ng-if="vm.user.lang === \'pl\'">Linkedin</label>\n                <span ng-show="form.linkedin.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <input type="text" name="linkedin" ng-pattern="/^[a-zA-Z0-9!:*\\., :/\\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107]*$/"\n                       id="linkedin" class="form-control"  ng-model="vm.user.linkedin"/>\n            </div>\n\n            <div class="form-group">\n                <label for="facebook" ng-if="vm.user.lang === \'en\'">Facebook</label>\n                <label for="facebook" ng-if="vm.user.lang === \'pl\'">Facebook</label>\n                <span ng-show="form.facebook.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <input type="text" name="facebook" ng-pattern="/^[a-zA-Z0-9!:*\\., :/\\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107]*$/"\n                       id="facebook" class="form-control"  ng-model="vm.user.facebook"/>\n            </div>\n\n            <div class="form-group">\n                <label for="twitter" ng-if="vm.user.lang === \'en\'">Twitter</label>\n                <label for="twitter" ng-if="vm.user.lang === \'pl\'">Twitter</label>\n                <span ng-show="form.twitter.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <input type="text" name="twitter" ng-pattern="/^[a-zA-Z0-9!:*\\., :/\\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107]*$/"\n                       id="twitter" class="form-control"  ng-model="vm.user.twitter"/>\n            </div>\n\n            <div class="form-group">\n                <label for="pyfunction" ng-if="vm.user.lang === \'en\'">PyFunction</label>\n                <label for="pyfunction" ng-if="vm.user.lang === \'pl\'">PyFunction</label>\n                <span ng-show="form.pyfunction.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <input type="text" name="pyfunction" ng-pattern="/^[a-zA-Z0-9!:*\\., :/\\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                       id="pyfunction" class="form-control"  ng-model="vm.user.pyfunction"/>\n            </div>\n\n\n            <div class="form-actions">\n                <button type="submit"\n                        ng-disabled="form.$invalid || vm.dataLoading"\n                        class="btn btn-primary">Update\n                </button>\n                <img ng-if="vm.dataLoading"\n                     src="data:image/gif;base64,"/>\n            </div>\n\n        </form>\n    </div>\n\n</div>\n\n');
$templateCache.put('partials/program.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Program  PyLadies.start()</h1>\n        </div>\n    </div>\n\n    <div class="row">\n        <div class="col-lg-6">\n            <h2>Warsztat weekendowy:</h2>\n            <ol>\n                <li>Instrukacja obs\u0142ugi warsztatu</li>\n                <li>Co to jest programowanie, Python, i do czego mo\u017Cna go wykorzysta\u0107</li>\n                <li>Przyjazne wprowadzenie do algorytmiki</li>\n                <li>Pierwsze kroki z interpreterem Pythona i IDE Pycharma</li>\n                <li>Python jako Kalkulator</li>\n                <li>Zmienna niczym kobieta</li>\n                <li>Jak wyt\u0142umaczy\u0107 w\u0119\u017Cowi o czym m\xF3wimy czyli - typy danych:\n                    znakowy, liczbowy i boolowski\n                </li>\n                <li>Zabawy ze stringami</li>\n                <li>Funkcje wbudowane</li>\n                <li>Logiczna logika</li>\n                <li>Warunkowe warunki</li>\n                <li>Listy zakup\xF3w</li>\n                <li>S\u0142owniki od A do Z</li>\n                <li>P\u0119tla dla ka\u017Cdego (for) zrobi\u0119 co\u015B fajnego</li>\n                <li>P\u0119tla dop\xF3ki mog\u0119 (while) b\u0119d\u0119 robi\u0142 co\u015B fajnego</li>\n                <li>nasza_funkcja()</li>\n                <li>\u0141apanie wyj\u0105tkowych b\u0142\u0119d\xF3w i trolli</li>\n                <li>Import losowo\u015Bci i innych Modu\u0142\xF3w</li>\n                <li>Powt\xF3rka ca\u0142o\u015Bci</li>\n            </ol>\n            <h3>W miar\u0119 mo\u017Cliwo\u015Bci:</h3>\n            <ol>\n                <li>Wszystko jest obiektem - wst\u0119p do programowania\n                    obiektowego\n                </li>\n                <li>Sukces i jego trzech ojc\xF3w \u2013 tolerancyjne dziedziczenie\n                </li>\n                <li>Hermetyzacja dzieci \u2013 rodzaje metod</li>\n            </ol>\n            <h2>Co tygodniowy warsztat Dwugodzinny zaczyna si\u0119 od lekcji na\n                kt\xF3rej\n                sko\u0144czy\u0142 si\u0119 warsztat weekendowy:</h2>\n\n            <h3>I semestr 16 spotka\u0144 od 4.10 do 13.12, od 10.01 do 14.02</h3>\n            <ol>\n                <li>Praca z plikami, format JSON</li>\n                <li>Biblioteki zewn\u0119trzne</li>\n                <li>Praca z API RESTowym</li>\n                <li>Git</li>\n                <li>Aplikacja webowa co to jest, jak wygl\u0105da to w Pythonie</li>\n                <li>Wst\u0119p do Flaska jednego z Pythonowych framework\xF3w</li>\n                <li>HTML i tworzenie wzornik\xF3w stron</li>\n                <li>Formularze</li>\n                <li>Python i bazy danych SQL</li>\n                <li>Python i bazy danych NO-SQL</li>\n                <li>Tworzenie API RESTowego</li>\n                <li>Delikatne om\xF3wienie czym jest JS i jQuery</li>\n                <li>Testy Jednostkowe</li>\n                <li>Testy jednostkowe aplikacji webowych</li>\n                <li>Scrum, Agile i wyb\xF3r projekt\xF3w Zespo\u0142owych</li>\n                <li>Powt\xF3rka i om\xF3wienie kolejnych krok\xF3w w projektach</li>\n            </ol>\n\n            <h3>II semestr 15 spotka\u0144 od 7.03 do 13.06</h3>\n            <ol>\n                <li>Om\xF3wienie projekt\xF3w zespo\u0142owych</li>\n                <li>PEP8, PyLint i metodologie programistyczne</li>\n                <li>Przechowywanie i tworzenie plik\xF3w konfiguracyjnych</li>\n                <li>SSH, AWS i serwery wirtualne</li>\n                <li>Deployment aplikacji webowej</li>\n                <li>Zaawansowane konstrukcje w Pythonie</li>\n                <li>Wyra\u017Cenie regularne</li>\n                <li>Zaawansowane funkcje w Pythonie</li>\n                <li>Zaawansowane funkcje w Pythonie II</li>\n                <li>Testy integracyjne aplikacji webowych - selenium</li>\n                <li>Projekt zespo\u0142owy I</li>\n                <li>Projekt zespo\u0142owy II</li>\n                <li>Projekt zespo\u0142owy III</li>\n                <li>Test sprawdzaj\u0105cy</li>\n                <li>Om\xF3wienie wynik\xF3w testu, projekt\xF3w</li>\n\n            </ol>\n        </div>\n        <div class="col-lg-6">\n            <h2>Weekend workshops - kickoff:</h2>\n            <ol>\n                <li> How to use the workshop and plan</li>\n                <li> What is programming, Python what for can use it</li>\n                <li> Friendly introduction to algorithms</li>\n                <li> First steps with Python interpreter and IDE PyCharm</li>\n                <li> Python as a calculator</li>\n                <li> Variable like a woman</li>\n                <li> How to explain the snake we are talking about - data\n                    types: character, numerical and Boolean\n                </li>\n                <li> Cheerful fun with strings</li>\n                <li> Built-in functions</li>\n                <li> Logical logic</li>\n                <li> Conditional conditions</li>\n                <li> Shopping lists</li>\n                <li> Dictionaries from A to Z</li>\n                <li> Loop for everyone (to do something cool)</li>\n                <li> Loop as long as (while) I will can do something cool</li>\n                <li> our_function()</li>\n                <li> Catching unique exceptions and trolls</li>\n                <li> Import of randomness and other Modules</li>\n                <li> Replay all over again</li>\n\n            </ol>\n            <h3>As far as possible:</h3>\n            <ol>\n                <li> Everything is an object - programming objectively</li>\n                <li> Success and their tree fathers - tolerant inheritance</li>\n                <li> Hermetizing children - methods types</li>\n            </ol>\n            <h2>Every weekday workshop Two-hour that will start of the point\n                where the weekend workshop ended:</h2>\n\n            <h3>1st term 16 meetings from 4.10 to 13.12, from 10.01 to\n                14.02</h3>\n            <ol>\n                <li> Working with files, JSON format</li>\n                <li> External Libraries</li>\n                <li> Working with the REST API</li>\n                <li> Git</li>\n                <li> Web application, Python frameworks</li>\n                <li> Introduction to Flask one of the Python frameworks</li>\n                <li> HTML and creating page templates</li>\n                <li> Forms</li>\n                <li> Python and SQL databases</li>\n                <li> Python and NO-SQL databases</li>\n                <li> Creating a REST API</li>\n                <li> Gentle introduction is JS and jQuery</li>\n                <li> Unit Testing</li>\n                <li> Unit testing of web applications</li>\n                <li> Scrum, Agile and teamwork project selection</li>\n                <li> Replay and discuss steps in projects</li>\n\n            </ol>\n\n            <h3>2nd term 15th meetings from 7.03 to 13.06</h3>\n            <ol>\n                <li> Overview of team projects</li>\n                <li> PEP8, PyLint, and development methodologies</li>\n                <li> Storing and creating configuration files</li>\n                <li> SSH, AWS, and virtual servers</li>\n                <li> Deployment of the web application</li>\n                <li> Advanced constructs in Python</li>\n                <li> Regular expression</li>\n                <li> Advanced features in Python</li>\n                <li> Advanced features in Python II</li>\n                <li> Integration testing of web applications - selenium</li>\n                <li> Team Project I</li>\n                <li> Team Project II</li>\n                <li> Team Design III</li>\n                <li> Year Test</li>\n                <li> Overview of the test results and team projects</li>\n\n            </ol>\n        </div>\n    </div>\n</div>');
$templateCache.put('partials/question_create.html','<div class="container">\n\n    <div class="row">\n\n        <div class="col-lg-12">\n            <h1 class="page-header">Create a question\n            </h1>\n\n        </div>\n\n    </div>\n\n\n    <form name="form" ng-submit="vm.new_question()" role="form">\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.question.$dirty && form.question.$error.required }">\n            <label for="question">Question</label>\n            <textarea type="text" name="question" id="question"\n                      class="form-control" ng-model="vm.n_question.question"\n                      required/></textarea>\n            <span ng-show="form.n_question.$dirty && form.n_question.$error.required"\n                  class="help-block">Question is required</span>\n        </div>\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.answer.$dirty && form.lastName.$error.required }">\n            <label for="answer">Possible Answer</label>\n            <input type="text" name="answer" id="Text2" class="form-control"\n                   ng-model="vm.n_question.possible_answare" required/>\n            <span ng-show="form.answer.$dirty && form.answer.$error.required"\n                  class="help-block">Possible Answe requriedr</span>\n\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.password.$dirty && form.password.$error.required }">\n                <label for="qtype">Question type</label><br>\n                <input class="form-inline text-left" type="radio" name="mentor"\n                       id="qtype_0" value="plain" class="form-control"\n                       ng-model="vm.n_question.qtype" required/> plain\n                <input class="form-inline float-right" type="radio"\n                       name="mentor" id="qtype_1" value="bool"\n                       class="form-control" ng-model="vm.n_question.qtype"\n                       required/> bool\n                <input class="form-inline float-right" type="radio"\n                       name="mentor" id="qtype_2" value="abcd"\n                       class="form-control" ng-model="vm.n_question.qtype"\n                       required/> abcd\n            </div>\n\n            <div class="form-group"\n             ng-show="vm.n_question.qtype === \'abcd\'">\n\n            <label for="ans_a">Answare A:</label>\n            <input type="text" name="answer" id="ans_a" class="form-control"\n                   ng-model="vm.n_question.ans_a" ng-required="vm.n_question.qtype === \'abcd\'"/>\n            <span ng-show="form.ans_a.$dirty && form.ans_a.$error.required"\n                  class="help-block">Answare A is required</span>\n\n                     <label for="ans_b">Answare B:</label>\n            <input type="text" name="answer" id="ans_b" class="form-control"\n                   ng-model="vm.n_question.ans_b" ng-required="vm.n_question.qtype === \'abcd\'"/>\n            <span ng-show="form.ans_b.$dirty && form.ans_b.$error.required"\n                  class="help-block">Answare B is required</span>\n\n\n                         <label for="ans_c">Answare C:</label>\n            <input type="text" name="answer" id="ans_c" class="form-control"\n                   ng-model="vm.n_question.ans_c" ng-required="vm.n_question.qtype === \'abcd\'"/>\n            <span ng-show="form.ans_c.$dirty && form.ans_c.$error.required"\n                  class="help-block">Answare C is required</span>\n\n                         <label for="ans_d">Answare D:</label>\n            <input type="text" name="answer" id="ans_d" class="form-control"\n                   ng-model="vm.n_question.ans_d" ng-required="vm.n_question.qtype === \'abcd\'"/>\n            <span ng-show="form.ans_d.$dirty && form.ans_d.$error.required"\n                  class="help-block">Answare D is required</span>\n\n            </div>\n\n            <div class="form-actions">\n                <button type="submit"\n                        ng-disabled="form.$invalid || vm.dataLoading"\n                        class="btn btn-primary">Submit\n                </button>\n                <img ng-if="vm.dataLoading"\n                     src="data:image/gif;base64,"/>\n            </div>\n    </form>\n\n\n</div>\n</div>\n<!-- /.container -->');
$templateCache.put('partials/question_list.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Questions</h1>\n    </div>\n    <div class="row">\n        <div class="col-lg-12">\n            <div class="panel-group" id="accordion">\n                <div class="panel panel-default" ng-repeat="x in vm.questions">\n                    <div class="panel-heading">\n                        <h4 class="panel-title">\n                            <a class="accordion-toggle" data-toggle="collapse" target="_self"\n                               data-parent="#accordion"\n                               href="#collapse_{{ x.id }}">\n                               {{ x.id }}.  {{ x.question }}\n                            </a>\n                        </h4>\n                    </div>\n                    <div id="collapse_{{ x.id }}" class="panel-collapse collapse">\n                        <div class="panel-body">\n                            Type: {{ x.qtype }} | Created by: {{  x.creator }}\n                            <br>\n                            Answares: {{ x.answares }}\n                            <br>\n                            Possible Answare: {{ x.possible_answare }}\n\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n</div>\n<!-- /.container -->');
$templateCache.put('partials/quiz.html','<div class="container">\n\n    <div class="row">\n\n        <div class="col-lg-12">\n            <h1 class="page-header">Quiz: {{ vm.quiz_title }}\n            </h1>\n        </div>\n\n    </div>\n\n    <div class="col-md-6 col-md-offset-3">\n        <p>\n            {{ vm.question.question }}\n            {{ vm.question.answare }}\n        </p>\n        <form name="form" ng-submit="vm.answare_question()" role="form" ng-hide="vm.question.last">\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.username.$dirty && form.username.$error.required }">\n                <label for="answer">Answer:</label>\n                <input type="text" name="answer" id="answer"\n                       class="form-control" ng-model="vm.answare" required/>\n                <span ng-show="form.answare.$dirty && form.answare.$error.required"\n                      class="help-block">Answer is required</span>\n            </div>\n\n            <div class="form-actions" ng-hide="vm.question.last">\n                <button type="submit"\n                        ng-disabled="form.$invalid || vm.dataLoading"\n                        class="btn btn-primary">Answare\n                </button>\n                <img ng-if="vm.dataLoading"\n                     src="data:image/gif;base64,"/>\n            </div>\n        </form>\n    </div>\n\n</div>\n<!-- /.container -->\n\n</div>\n<!-- /.container -->');
$templateCache.put('partials/quiz_create.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Create new quiz\n            </h1>\n        </div>\n    </div>\n    <form name="form" ng-submit="vm.create_quiz()" role="form">\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.answer.$dirty && form.lastName.$error.required }">\n            <label for="title">Title</label>\n            <input type="text" name="title" id="Text2" class="form-control"\n                   ng-model="vm.lesson.title" required/>\n            <span ng-show="form.lesson.$dirty && form.lesson.$error.required"\n                  class="help-block">Title is required</span>\n        </div>\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.firstName.$dirty && form.firstName.$error.required }">\n            <label for="description">description</label>\n            <textarea type="text" name="description" id="firstName"\n                      class="form-control" ng-model="vm.lesson.description"\n                      required/></textarea>\n            <span ng-show="form.lesson.$dirty && form.lesson.$error.required"\n                  class="help-block">Description is required</span>\n        </div>\n        <div class="form-group"\n             ng-class="{ \'has-error\': form.lastName.$dirty && form.lastName.$error.required }">\n            <label for="lesson">Questions:</label>\n            <div class="checkbox" ng-repeat="qiz in vm.questions">\n                <label ><input ng-model="vm.lesson.questions[qiz.id]" type="checkbox" value="{{ qiz.id }}">{{ qiz.question }}</label>\n            </div>\n            <span ng-show="form.file.$dirty && form.file.$error.required"\n                  class="help-block">Link for presentation is required</span>\n        </div>\n        <div class="form-actions">\n            <button type="submit" ng-disabled="form.$invalid || vm.dataLoading"\n                    class="btn btn-primary">Create\n            </button>\n            <img ng-if="vm.dataLoading"\n                 src="data:image/gif;base64,"/>\n        </div>\n    </form>\n</div>\n</div>\n<!-- /.container -->');
$templateCache.put('partials/quiz_list.html','<div class="container">\n\n    <div class="row">\n\n        <div class="col-lg-12">\n            <h1 class="page-header">Quizes\n                <small>Avalaible quizes</small>\n            </h1>\n        </div>\n\n    </div>\n\n    <div class="row">\n\n        <div class="col-sm-3" ng-repeat="q in vm.quizes">\n            <div class="panel panel-default text-center">\n                <div class="panel-heading">\n                    <strong>{{ q.title }}</strong>\n                </div>\n                <div class="panel-body">\n                    <h3 class="panel-title price">{{ q.amount }}\n                        <span class="price-month">questions</span>\n                    </h3>\n                </div>\n                <ul class="list-group">\n                    <li class="list-group-item">{{ q.description }}</li>\n                    <li class="list-group-item">{{ q.creator }}</li>\n                    <li class="list-group-item"><a class="btn btn-primary" ng-click="vm.start( q.id )">Start now !</a>\n                    </li>\n                </ul>\n            </div>\n        </div>\n\n    </div>\n\n</div>');
$templateCache.put('partials/regconfirmed.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Rejestracja potwierdzona, mo\u017Cesz si\u0119 logowa\u0107 !</h1>\n        </div>\n    </div>\n    <div class="row">\n        <div class="col-lg-12">\n            <h2>Rejestracja zako\u0144czy si\u0119 10.09.2017. Odpowied\u017A o przyj\u0119ciu przyjdzie do ko\u0144ca dnia 14.09.2017</h2>\n\n            <h3>Pami\u0119taj, \u017Ce od momentu otrzymania informacji o pozytywnym wyniku rekrutacji masz 72 godziny na potwierdzenie swojej obecno\u015Bci, inaczej Twoje miejsce przepadnie.</h3>\n        </div>\n    </div>\n</div>');
$templateCache.put('partials/register.html','<div class="container" xmlns="http://www.w3.org/1999/html">\n    <h3 ng-if="!vm.reg">Registration is closed now !</h3>\n\n\n    <div class="col-md-6 col-md-offset-3" ng-if="vm.reg">\n        <h3 ng-hide="vm.user.lang === \'pl\'">Language:</h3>\n        <h3 ng-show="vm.user.lang === \'pl\'">J\u0119zyk:</h3>\n        <form name="form" ng-submit="vm.register()" role="form">\n            <div class="form-group">\n                <label for="lang">\n                    <input class="form-inline text-left" type="radio"\n                           name="lang" id="lang" value="pl"\n                           ng-model="vm.user.lang"\n                           required/> Polski\n                    <input class="form-inline float-right" type="radio"\n                           name="lang" id="lang" value="en"\n                           ng-model="vm.user.lang"\n                           required/> English\n                </label>\n            </div>\n            <div ng-show="vm.user.lang">\n            <h4 ng-if="vm.user.lang === \'en\'">Account</h4><h4 ng-if="vm.user.lang === \'pl\'"> Konto</h4>\n            <p>\n                <div ng-if="vm.user.lang === \'en\'">\n                This data is needed for you to be able to login to this application,\n                and also for us to contact you and inform you about the outcome of the recruitment process.\n                </div>\n                <div ng-if="vm.user.lang === \'pl\'">\n                Poni\u017Csze informacje s\u0105 potrzebne, \u017Ceby si\u0119 z Tob\u0105 skontaktowa\u0107\n                i poinformowa\u0107 o wynikach rekrutacji oraz \u017Ceby\u015B mog\u0142a/mog\u0142 si\u0119 zalogowa\u0107 do tej aplikacji.\n                    </div>\n            </p>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.username.$dirty && form.username.$error.required }">\n                <label for="email">E-Mail</label>\n                <span ng-show="form.email.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.email.$invalid"\n                      class="help-inline alert-danger">&#10060; Invalid e-mail </span>\n                <span ng-show="form.email.$dirty && form.email.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <input type="email" name="email" id="email"\n                       class="form-control" ng-model="vm.user.email" required/>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.password.$dirty && form.password.$error.required }">\n                <label for="password" ng-if="vm.user.lang === \'en\'">Password</label>\n                <label for="password" ng-if="vm.user.lang === \'pl\'"> Has\u0142o</label>\n                <span ng-show="form.password.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.password.$error.minlength "\n                      class="help-inline alert-danger">Minimal length 8</span>\n                <span ng-show="form.password.$dirty && form.password.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <input ng-minlength="8" type="password" name="password"\n                       id="password" class="form-control"\n                       ng-model="vm.user.password" required/>\n            </div>\n\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.name.$dirty && form.name.$invalid }">\n                <label for="name" ng-if="vm.user.lang === \'en\'">First name</label>\n                <label for="name" ng-if="vm.user.lang === \'pl\'"> Imi\u0119</label>\n                <span ng-show="form.name.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.name.$error.minlength "\n                      class="help-inline alert-danger">Minimal length 3</span>\n                <span ng-show="form.name.$dirty && form.name.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <span ng-show="form.name.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters</span>\n                <input ng-minlength="3" type="text" name="name" id="name" ng-pattern="/^[a-zA-Z \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                       class="form-control" ng-model="vm.user.name" required/>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.surname.$dirty && form.lastName.$error.required }">\n                <label for="surname" ng-if="vm.user.lang === \'en\'">Last name</label>\n                <label for="surname" ng-if="vm.user.lang === \'pl\'">Nazwisko</label>\n                <span ng-show="form.surname.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.surname.$error.minlength "\n                      class="help-inline alert-danger">Minimal length 3</span>\n                <span ng-show="form.surname.$dirty && form.surname.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <span ng-show="form.surname.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters</span>\n                <input ng-minlength="3" type="text" name="surname" id="surname" ng-pattern="/^[a-zA-Z \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                       class="form-control" ng-model="vm.user.surname"\n                       required/>\n            </div>\n\n                 <h4  ng-if="vm.user.lang === \'en\'">Stats</h4>\n                <h4  ng-if="vm.user.lang === \'pl\'">Statystyka</h4>\n                <p  ng-if="vm.user.lang === \'en\'">\n                    Below data is just for statistics, that easeas our cooperation\n                with partners and sponsors.</p>\n                <p  ng-if="vm.user.lang === \'pl\'"> Poni\u017Csze dane s\u0105 nam potrzebne do statystyk, kt\xF3re potem\n                u\u0142atwiaj\u0105 nam wsp\xF3\u0142prac\u0119 z partnerami i sponsorami.</p>\n\n\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.city.$dirty && form.password.$error.required }">\n                <label for="city" ng-if="vm.user.lang === \'en\'">City</label>\n                <label for="city" ng-if="vm.user.lang === \'pl\'">Miejscowo\u015B\u0107</label>\n                <span ng-show="form.city.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.city.$error.minlength "\n                      class="help-inline alert-danger">Minimal length 3</span>\n                <span ng-show="form.city.$dirty && form.city.$valid" class="help-inline alert-success">&#10003;</span>\n                <span ng-show="form.city.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters</span>\n                <input ng-minlength="3" type="text" name="city" id="city" ng-pattern="/^[a-zA-Z \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                       class="form-control" ng-model="vm.user.city" required/>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.age.$dirty && form.age.$error.required }">\n                <label for="age" ng-if="vm.user.lang === \'en\'">Age</label>\n                <label for="age" ng-if="vm.user.lang === \'pl\'">Wiek</label>\n                <span ng-show="form.age.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.age.$error.pattern"\n                      class="help-inline alert-danger">\n                    <p ng-if="vm.user.lang === \'en\'">You need to input age between 10 and 99 years</p>\n                        <p ng-if="vm.user.lang === \'pl\'">Wprowad\u017A wiek od 16 do 99 lat</p>\n                </span>\n                <span ng-show="form.age.$error.number"\n                      class="help-inline alert-danger">&#10060; Must be a positive number</span>\n                 <input name="age" id="age"  type="number" ng-model="vm.user.age" ng-pattern="/^[0-9]{2}$/" required/>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.lastName.$dirty && form.lastName.$error.required }">\n                <label for="education" ng-if="vm.user.lang === \'en\'">Education</label>\n                <label for="education" ng-if="vm.user.lang === \'pl\'">Edukacja</label>\n                <select class="form-control" ng-if="vm.user.lang === \'en\'" ng-options="x for x in [\'Elementary\', \'Gymnasium\', \'Vocational\', \'Technician\', \'High School\', \'BA degree\', \'Engineer\', \'MA degree\', \'PhD\']"  ng-model="vm.user.education" ngValue="x"></select >\n                <select class="form-control" ng-if="vm.user.lang === \'pl\'" ng-options="x for x in [\'Podstawowe\', \'Gimnazjalne\', \'Zawodowe\', \'Techniczne\', \'\u015Arednie\', \'Licencjat\', \'In\u017Cynier\', \'Magister\', \'Doktor\']"  ng-model="vm.user.education" ngValue="x"></select >\n            </div>\n\n            <div class="form-group" ng-class="{ \'has-error\': form.university.$dirty && form.university.$error.required }">\n                <label for="university" ng-if="vm.user.lang === \'en\'">University - ongoing or graduate</label>\n                <label for="university" ng-if="vm.user.lang === \'pl\'">Szko\u0142a wy\u017Csza - aktualna lub uko\u0144czona</label>\n                <span ng-show="form.university.$error.required" class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.university.$dirty && form.university.$valid" class="help-inline alert-success">&#10003;</span>\n                <select class="form-control" ng-options="x for x in [\'None-Brak\', \'UAM\', \'PP\', \'UP\', \'UE\', \'UM\', \'CDV\', \'WSB\', \'OTHER\']"\n                        ng-model="vm.user.university" ngValue="x" required name="university" id="university">\n                    <option></option>\n                </select>\n\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.t_shirt.$dirty && form.t_shirt.$error.required }">\n                <label for="t_shirt">T-shirt*</label>\n                <span ng-show="form.t_shirt.$error.required" class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.t_shirt.$dirty && form.t_shirt.$valid" class="help-inline alert-success">&#10003;</span>\n                <select class="form-control" ng-options="x for x in\n                [\'Female-XXS\', \'Female-XS\', \'Female-S\', \'Female-M\', \'Female-L\', \'Female-XL\', \'Female-XXL\', \'Female-XXXL\', \'Male-XS\', \'Male-S\', \'Male-M\', \'Male-L\', \'Male-XL\', \'Male-XXL\', \'Male-XXXL\']"\n                        ng-model="vm.user.t_shirt" ngValue="x" required name="t_shirt" id="t_shirt">\n                    <option></option>\n                </select>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.operating_system.$dirty && form.operating_system.$error.required }">\n                <label for="operating_system" ng-if="vm.user.lang === \'en\'">Operating System</label>\n                <label for="operating_system" ng-if="vm.user.lang === \'pl\'">System Operacyjny</label>\n                <span ng-show="form.operating_system.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.operating_system.$dirty && form.operating_system.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <select class="form-control" ng-options="x for x in [\'MacOS\', \'Linux\', \'Windows\']"\n                        ng-model="vm.user.operating_system" ngValue="x" name="operating_system" id="operating_system"\n                        required><option></option>\n                </select >\n            </div>\n\n                <h4  ng-if="vm.user.lang === \'en\'">About You</h4>\n                <h4 for="city" ng-if="vm.user.lang === \'pl\'">O Tobie</h4>\n                <p ng-if="vm.user.lang === \'en\'">\n                     <strong>Attendee</strong><br>\n                    Tell us about your motivations behind your decision to start learning programming\n                <br><strong>Mentor:</strong><br>\n                    If you are new with us, we would like to know you a little bit better; if you are our old fellow, please provide your short bio :)\n\n                </p>\n\n                <p ng-if="vm.user.lang === \'pl\'">\n                    <strong>Uczestnik</strong> <br>\n                Przede wszystkim chcemy pozna\u0107 Twoje motywy podj\u0119cia decyzji o rozpocz\u0119ciu programowania w Pythonie oraz dowiedzie\u0107 si\u0119, jakie masz do\u015Bwiadczenie.\n                <br><strong>Mentor:</strong><br>\n                    Je\u015Bli dopiero zaczynasz przygod\u0119 z PyLadies - chcieliby\u015Bmy Ci\u0119 bli\u017Cej pozna\u0107, a je\u015Bli ju\u017C z nami wsp\xF3\u0142pracowa\u0142e\u015B, zamie\u015B\u0107 tutaj swoje kr\xF3tkie bio :)\n                </p>\n\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.password.$dirty && form.password.$error.required }">\n                <label for="mentor">\n                    <span ng-show="form.mentor.$error.required"\n                          class="help-inline alert-danger">&#10060; Required</span>\n                    <span ng-show="form.mentor.$dirty && form.mentor.$valid"\n                          class="help-inline alert-success">&#10003;</span>\n                    <input class="form-inline text-left" type="radio"\n                           name="mentor" id="mentor" value="false"\n                           class="form-control" ng-model="vm.user.mentor"\n                           required/>\n                    <xxxx ng-if="vm.user.lang === \'en\'">Attendee</xxxx>\n                    <xxxx ng-if="vm.user.lang === \'pl\'">Uczestnik</xxxx>\n                    <input class="form-inline float-right" type="radio"\n                           name="mentor" id="mentor" value="true"\n                           class="form-control" ng-model="vm.user.mentor"\n                           required/> Mentor\n                </label>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.password.$dirty && form.password.$error.required }">\n                <label for="description" ng-if="vm.user.lang === \'en\'">Write something about yourself</label>\n                <label for="description" ng-if="vm.user.lang === \'pl\'">Napisz co\u015B o sobie.</label>\n                <span ng-show="form.description.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.description.$error.minlength "\n                      class="help-inline alert-danger">Minimal length 65</span>\n                <span ng-show="form.description.$dirty && form.description.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <span ng-show="form.description.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <textarea ng-minlength="65" type="text" name="description"\n                          id="description" class="form-control" ng-pattern="/^[a-zA-Z0-9!:*., \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                          ng-model="vm.user.description" required/>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.password.$dirty && form.password.$error.required }">\n                <label for="motivation" ng-if="vm.user.lang === \'en\'">Motivation - Why do you want to participate in the workshop?</label>\n                <label for="motivation" ng-if="vm.user.lang === \'pl\'">Motywacja - Dlaczego chcesz wzi\u0105\u0107 udzia\u0142 w warsztatch?</label>\n                <span ng-show="form.motivation.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.motivation.$error.minlength "\n                      class="help-inline alert-danger">Minimal length 65</span>\n                <span ng-show="form.motivation.$dirty && form.motivation.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <textarea ng-minlength="65" type="text" name="motivation"\n                          id="motivation" class="form-control"\n                          ng-model="vm.user.motivation" required/>\n            </div>\n            <br>\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.experience.$dirty && form.experience.$error.required }">\n                <label for="experience" ng-if="vm.user.lang === \'en\'">Experience</label>\n                <label for="experience" ng-if="vm.user.lang === \'pl\'">Do\u015Bwiadczenie</label>\n                <span ng-show="form.experience.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <span ng-show="form.experience.$dirty && form.experience.$valid"\n                      class="help-inline alert-success">&#10003;</span>\n                <select class="form-control" ng-if="vm.user.lang === \'en\'" ng-options="x for x in [\n                \'I have none\',\n                \'I had some but I do not remember anything\',\n                \'I know the basics\',\n                \'I can program\',\n                \'I know another programming language well\',\n                \'I am an experienced programmer\'\n                ]"\n                        ng-model="vm.user.experience" ngValue="x"\n                        required name="experience" id="experience">\n                    </select >\n                <select class="form-control" ng-if="vm.user.lang === \'pl\'" ng-options="x for x in [\n                \'Nie posiadam wcale\',\n                \'Co\u015B tam robi\u0142am/em, ale nic nie pami\u0119tam\',\n                \'Znam podstawy\',\n                \'Umiem programowa\u0107\',\n                \'Znam dobrze inny j\u0119zyk programowania\',\n                \'Jestem do\u015Bwiadczonym programist\u0105\'\n                ]"\n                        ng-model="vm.user.experience" ngValue="x"\n                        required name="experience" id="experience">\n                    </select >\n            </div>\n            <br>\n            <div class="checkbox"\n                 ng-class="{ \'has-error\': form.python.$dirty && form.python.$error.required }"\n                 ng-hide="vm.user.mentor == \'mentor\'">\n                <label for="python"><input type="checkbox" name="i_helped"\n                                           id="python"\n                                           ng-model="vm.user.python">\n                <p ng-if="vm.user.lang === \'en\'">Did you already install Python using following link:</p>\n                <p ng-if="vm.user.lang === \'pl\'">Czy zainstalowa\u0142e\u015B ju\u017C Pythona u\u017Cywajac tego linku:</p>\n                    <a href="https://www.youtube.com/watch?v=0d6znPZb3PQ&t=3s">https://www.youtube.com/watch?v=0d6znPZb3PQ&t=3s</a>\n                </label>\n            </div>\n\n            <div class="checkbox" ng-hide="vm.user.mentor == \'mentor\'">\n                <label for="bring_power_cord"><input type="checkbox" name="bring_power_cord"\n                                           id="bring_power_cord"\n                                           ng-model="vm.user.bring_power_cord">\n                <p ng-if="vm.user.lang === \'en\'">Can you bring a power extension cord with you?</p>\n                <p ng-if="vm.user.lang === \'pl\'">Czy mo\u017Cesz przynie\u015B\u0107 na warsztat przed\u0142u\u017Cacz?</p>\n                </label>\n            </div>\n\n            <div class="checkbox" ng-hide="vm.user.mentor == \'mentor\'">\n                <label for="attend_weekly"><input type="checkbox" name="attend_weekly"\n                                           id="attend_weekly"\n                                           ng-model="vm.user.attend_weekly">\n                <p ng-if="vm.user.lang === \'en\'">Are you planning to attend the weekly PyLadies meetings after this workshop?</p>\n                <p ng-if="vm.user.lang === \'pl\'">Czy zamierzasz kontynuowa\u0107 nauk\u0119 z nami co tydzie\u0144 po warsztacie weeekendowym?</p>\n                </label>\n            </div>\n\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.password.$dirty && form.password.$error.required }"\n                 ng-hide="vm.user.mentor == \'mentor\'">\n                <label for="app_idea" ng-if="vm.user.lang === \'en\'">What are you planning to do with the knowledge you gain during this workshop? Do you have an app idea?</label>\n                <label for="app_idea" ng-if="vm.user.lang === \'pl\'">Do czego chcia\u0142aby\u015B/chcia\u0142by\u015B wykorzysta\u0107 wiedz\u0119 z warsztat\xF3w? Czy masz pomys\u0142 na w\u0142asn\u0105 aplikacj\u0119?</label>\n                                <span ng-show="form.app_idea.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <textarea type="text" name="app_idea" id="app_idea" ng-pattern="/^[a-zA-Z0-9!:*., \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                          class="form-control" ng-model="vm.user.app_idea"/>\n            </div>\n\n            <div class="form-group" ng-hide="vm.user.mentor == \'mentor\'"\n                 ng-class="{ \'has-error\': form.experience.$dirty && form.password.$error.required }">\n                <label for="what_can_you_bring" ng-if="vm.user.lang === \'en\'">What will you bring and share\n                    to eat or drink? This is a community workshop, everyone should contribute :) You can bake something,\n                    brings sandwiches, buy some snacks or juices/drinks, we are open to your ideas.\n                    </label>\n                <label for="what_can_you_bring" ng-if="vm.user.lang === \'pl\'">Co przyniesisz do podzielenia si\u0119 do jedzenia i\n                    picia? To jest warsztat spo\u0142eczny, ka\u017Cdy jest proszony o do\u0142\u0105czenie si\u0119.\n                    Mo\u017Cesz co\u015B upiec, zrobi\u0107 kanapki, kupi\u0107 przek\u0105ski lub soki/napoje - jeste\u015Bmy otwarci pod tym wzgl\u0119dem.</label>\n                                <span ng-show="form.what_can_you_bring.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                                <input type="text" name="what_can_you_bring" ng-pattern="/^[a-zA-Z0-9!:*., \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                       id="what_can_you_bring" class="form-control"\n                       ng-model="vm.user.what_can_you_bring"/>\n            </div>\n\n            <div class="checkbox"\n                 ng-class="{ \'has-error\': form.i_helped.$dirty && form.i_helped.$error.required }"\n                 ng-hide="vm.user.mentor == \'mentor\'">\n                <label for="i_helped"><input type="checkbox" name="i_helped"\n                                             id="i_helped"\n                                             ng-model="vm.user.i_helped">\n                    <p ng-if="vm.user.lang === \'en\'">I helped with organisation!</p>\n                <p ng-if="vm.user.lang === \'pl\'">Pomog\u0142am/Pomog\u0142em przy organizacji!</p>\n\n                </label>\n            </div>\n\n            <div class="form-group"\n                 ng-class="{ \'has-error\': form.password.$dirty && form.password.$error.required }"\n                 ng-show="vm.user.i_helped">\n                <label for="helped" ng-if="vm.user.lang === \'en\'">Helped with</label>\n                <label for="helped" ng-if="vm.user.lang === \'pl\'">Pomog\u0142am/pomog\u0142em w</label>\n                <span ng-show="form.helped.$error.pattern"\n                      class="help-inline alert-danger">Can contain only letters, number and !:*.,</span>\n                <textarea type="text" name="helped" id="helped" ng-pattern="/^[a-zA-Z0-9!:*., \\-\u0119\xF3\u0105\u0142\u017C\u017A\u0144\u015B\u0107\u0118\xD3\u0141\u017B\u0179\u0106\u0143\u0104\u015A]*$/"\n                          class="form-control" ng-model="vm.user.helped"/>\n            </div>\n\n            <br>\n\n\n            <div class="checkbox"\n                 ng-class="{ \'has-error\': form.accepted_rules.$dirty && form.accepted_rules.$error.required }">\n                <span ng-show="form.accepted_rules.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <label for="accepted_rules">\n                    <input type="checkbox" name="accepted_rules"\n                           id="accepted_rules"\n                           ng-model="vm.user.accepted_rules" required/>\n                <p ng-if="vm.user.lang === \'en\'">I have read and accepted Rules, Terms and Code of conduct.</p>\n                <p ng-if="vm.user.lang === \'pl\'">Przeczyta\u0142em i akceptuj\u0119 <a href="#/rules">Regulamin</a> oraz Code of conduct.</p>\n                </label>\n            </div>\n\n            <div class="checkbox"\n                 ng-class="{ \'has-error\': form.notebook.$dirty && form.notebook.$error.required }">\n                <span ng-show="form.notebook.$error.required"\n                      class="help-inline alert-danger">&#10060; Required</span>\n                <label for="notebook">\n                    <input type="checkbox" name="notebook"\n                           id="notebook"\n                           ng-model="vm.user.notebook" required/>\n\n                    <p ng-if="vm.user.lang === \'en\'">I know I have to bring my own Notebook.</p>\n                <p ng-if="vm.user.lang === \'pl\'">Wiem \u017Ce musz\u0119 przynie\u015B\u0107 swojego laptopa.</p>\n                </label>\n            </div>\n\n            <div class="form-actions">\n                <button type="submit"\n                        ng-disabled="form.$invalid || vm.dataLoading"\n                        class="btn btn-primary">Register\n                </button>\n                <img ng-if="vm.dataLoading"\n                     src="data:image/gif;base64,"/>\n            </div>\n                <p ng-if="vm.user.lang === \'en\'">*At this point we are not sure if there will be any t-shirts for attendees.</p>\n                <p ng-if="vm.user.lang === \'pl\'">*Na chwil\u0119 obecn\u0105 nie mo\u017Cemy obieca\u0107, \u017Ce b\u0119d\u0105 koszulki dla uczestnik\xF3w.</p>\n            </h4>\n            </div>\n        </form>\n    </div>\n\n</div>\n');
$templateCache.put('partials/rules.html','<div class="container">\n    <div class="row">\n        <div class="col-lg-12">\n            <h1 class="page-header">Regulamin warsztat\xF3w PyLadies.start()</h1>\n        </div>\n    </div>\n    <div class="row">\n        <div class="col-lg-12">\n\n<ol>\n<li>Organizatorem wydarzenia \u201EPyLadies.start()\u201D (dalej zwanego Warsztatem) jest wolontariacka spo\u0142eczno\u015B\u0107 PyLadies Pozna\u0144, zwana dalej Organizatorem.</li>\n<li>Strona Internetowa Organizatora to poland.pyladies.com</li>\n<li>Warsztat odbywa si\u0119 w dniach 23-24.09.2017 r. w  Poznaniu.</li>\n<li>Mentor wiod\u0105cy b\u0119dzie prowadzi\u0142 wyk\u0142ad, na sali uczestnik\xF3w b\u0119d\u0105 wspierali mentorzy wspieraj\u0105cy. Na 10 uczestnik\xF3w b\u0119dzie przypada\u0142 jeden mentor.</li>\n<li>Na Warsztat nale\u017Cy przyj\u015B\u0107 z w\u0142asnym laptopem i zainstalowanym wed\u0142ug wskaz\xF3wek Organizatora \u015Brodowiskiem. Organizator zdalnie aktywnie wesprze uczestnik\xF3w w instalacji \u015Brodowiska. Organizator wska\u017Ce Uczestnikom metod\u0119 uzyskiwania tego wsparcia.</li>\n<li>Liczba miejsc jest ograniczona do maksymalnie 200 os\xF3b.</li>\n<li>W wypadku wi\u0119kszej liczby zg\u0142osze\u0144, Uczestnicy zostan\u0105 wybrani na podstawie oceny Organizatora.</li>\n<li>Uczestnikiem Warsztatu jest ka\u017Cda osoba, kt\xF3ra prawid\u0142owo wype\u0142nieni formularz rejestracyjny znajduj\u0105cy si\u0119 na stronie internetowej wydarzenia, zaakceptuje niniejszy Regulamin, otrzyma informacj\u0119 o zakwalifikowaniu si\u0119 na Warsztat i w terminie 72 godzin od tej informacji potwierdzi swoje uczestnictwo w Warsztacie metod\u0105 wskazan\u0105 przez Organizatora.</li>\n<li>W razie nie potwierdzenia uczestnictwa, uczestnik zostanie skre\u015Blony z listy bior\u0105cych udzia\u0142 w Warsztacie i na jego miejsce zostanie zaproszona osoba z listy rezerwowej. Zakwalifikowana w ten spos\xF3b osoba stanie si\u0119 Uczestnikiem Warsztatu, je\u015Bli w terminie do 48 godzin potwierdzi swoje uczestnictwo w Warsztacie metod\u0105 wskazan\u0105 przez Organizatora.</li>\n<li>Uczestnik wyra\u017Ca zgod\u0119 na wykorzystywanie zdj\u0119\u0107 i nagra\u0144 ze swoim wizerunkiem, powsta\u0142ych podczas Warsztatu. B\u0119d\u0105 one powielane w mediach oraz materia\u0142ach promocyjnych Organizatora m.in. na stronach internetowych, w social media, jak r\xF3wnie\u017C poprzez og\xF3lnodost\u0119pne \u015Brodki masowego przekazu (prasa, radio, telewizja, internet).</li>\n<li>Uczestnik wyra\u017Ca zgod\u0119 na otrzymywanie informacji zwi\u0105zanych z Warsztatem od Organizatora oraz od sponsor\xF3w i partner\xF3w za po\u015Brednictwem Organizatora drog\u0105 elektroniczn\u0105.</li>\n<li>Imi\u0119 i nazwisko oraz adres mailowy Uczestnika zostan\u0105 wykorzystane przez Organizatora tylko dla potrzeb niniejszego Warsztatu i nie zostan\u0105 udost\u0119pnione \u017Cadnemu podmiotowi.</li>\n<li>Uczestnik bior\u0105cy udzia\u0142 w Warsztacie bierze pe\u0142n\u0105 odpowiedzialno\u015B\u0107 prawn\u0105 i finansow\u0105 za swoje czyny.</li>\n<li>Uczestnik o\u015Bwiadcza, \u017Ce jest pe\u0142noletni lub, je\u015Bli ma sko\u0144czone 16 lat, posiada zgod\u0119 pisemn\u0105 rodzica/opiekuna prawnego, kt\xF3r\u0105 dostarczy Organizatorowi w czasie rejestracji Uczestnik\xF3w Warsztatu w pierwszym dniu wydarzenia.</li>\n<li>Organizator zastrzega sobie prawo do zmian w Regulaminie i programie Warsztatu. Organizator ma obowi\u0105zek poinformowa\u0107 Uczestnik\xF3w o wszelkich ewentualnych zmianach w Regulaminie.</li>\n<li>Warsztat jest bezp\u0142atny dla uczestnik\xF3w. Organizator nie op\u0142aca zakwaterowania, ani \u017Cadnych innych potrzeb Uczestnik\xF3w poza Warsztatem.</li>\n<li>Warsztat jest organizowany i prowadzony w j\u0119zyku polskim. Zostan\u0105 wykorzystane materia\u0142y szkoleniowe w j\u0119zyku polskim.</li>\n<li>Poprawne wype\u0142nienie formularza jest r\xF3wnoznaczne z akceptacj\u0105 Regulaminu.</li>\n\n</ol>\n        </div>\n    </div>\n</div>');
$templateCache.put('partials/seats.html','<link rel="stylesheet" href="css/seats.css">\n\n<div class="container">\n    <div class="row">\n\n        <div class="col-md-12" ng-if="vm.current_user.confirmation === \'ack\' || vm.overview">\n            <h1 ng-hide="vm.overview">Wybierz swoje miejsce!</h1>\n            <h1 ng-show="vm.overview">Miejsca uczestnik\xF3w</h1>\n            <br>\n            <div class="exit">\n            </div>\n            <div class="plane">\n                <ol>\n                    <li class="row" ng-repeat="(raw, y) in vm.seats">\n                        <ol class="seats" type="A">\n                            <li class="seat" ng-repeat="(number, user) in y">\n                                <input ng-click="vm.take_or_relese_seat(raw, number, user)"\n                                       type="checkbox"\n                                       id="{{ raw }}{{ number }}"\n                                       ng-disabled="vm.user_seat.users && (vm.user_seat.row != raw || vm.user_seat.number != number) || user.empty_raw"\n                                       ng-checked="vm.user_seat.raw === raw && vm.user_seat.number === number"/>\n                                <label for="{{ raw }}{{ number }}" data-toggle="tooltip" data-placement="top" title="{{ user.user }}"\n                                       ng-class="{\'empty_raw\': user.empty_raw, \'i_need_help\': user.i_need_help, \'taken\': user.user && vm.user_seat.users != user.user_id, \'my_seat\': user.user_id && vm.user_seat.users === user.user_id}">\n                                    <x ng-hide="user.empty_raw || user.i_need_help">{{ raw }}{{ number }}</x>\n                                    <x ng-show="user.i_need_help">{{ user.name }}</x>\n                                </label>\n                            </li>\n                        </ol>\n                    </li>\n\n                </ol>\n\n            </div>\n\n        </div>\n\n        <div class="col-md-12" ng-if="vm.current_user.confirmation != \'ack\' && !vm.overview">\n        <h3>Tylko u\u017Cytkownicy kt\xF3rzy zostali przyj\u0119ci i potwierdzili swoj\u0105 obecno\u015B\u0107 b\u0119d\u0105 mie\u0107 dost\u0119p do wyboru miejsc.</h3>\n        </div>\n\n    </div>\n</div>');}]);